...
package ESP32C3_SVD.GPIO is
   ...
   subtype OUT_DATA_ORIG_Field is ESP32C3_SVD.UInt26;
   ...
   subtype OUT_W1TS_OUT_W1TS_Field is ESP32C3_SVD.UInt26;
   ...
   subtype OUT_W1TC_OUT_W1TC_Field is ESP32C3_SVD.UInt26;
   ...
   subtype SDIO_SELECT_SDIO_SEL_Field is ESP32C3_SVD.UInt8;
   ...
   subtype ENABLE_DATA_Field is ESP32C3_SVD.UInt26;
   ...
   subtype ENABLE_W1TS_ENABLE_W1TS_Field is ESP32C3_SVD.UInt26;
   ...
   subtype ENABLE_W1TC_ENABLE_W1TC_Field is ESP32C3_SVD.UInt26;
   ...
   subtype STRAP_STRAPPING_Field is ESP32C3_SVD.UInt16;
   ...
   subtype IN_DATA_NEXT_Field is ESP32C3_SVD.UInt26;
   ...
   type IN_Register is record
      ...
      --  unspecified
      Reserved_26_31 : ESP32C3_SVD.UInt6;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype STATUS_INTERRUPT_Field is ESP32C3_SVD.UInt26;
   ...
   subtype STATUS_W1TS_STATUS_W1TS_Field is ESP32C3_SVD.UInt26;
   ...
   subtype STATUS_W1TC_STATUS_W1TC_Field is ESP32C3_SVD.UInt26;
   ...
   subtype PCPU_INT_PROCPU_INT_Field is ESP32C3_SVD.UInt26;
   ...
   subtype PCPU_NMI_INT_PROCPU_NMI_INT_Field is ESP32C3_SVD.UInt26;
   ...
   subtype CPUSDIO_INT_SDIO_INT_Field is ESP32C3_SVD.UInt26;
   ...
   subtype PIN_PIN_SYNC2_BYPASS_Field is ESP32C3_SVD.UInt2;
   subtype PIN_PIN_SYNC1_BYPASS_Field is ESP32C3_SVD.UInt2;
   subtype PIN_PIN_INT_TYPE_Field is ESP32C3_SVD.UInt3;
   subtype PIN_PIN_CONFIG_Field is ESP32C3_SVD.UInt2;
   subtype PIN_PIN_INT_ENA_Field is ESP32C3_SVD.UInt5;

   --  GPIO pin configuration register
   type PIN_Register is record
      --  set GPIO input_sync2 signal mode. :disable. 1:trigger at negedge.
      --  2or3:trigger at posedge.
      PIN_SYNC2_BYPASS  : PIN_PIN_SYNC2_BYPASS_Field := 16#0#;
      --  set this bit to select pad driver. 1:open-drain. :normal.
      PIN_PAD_DRIVER    : Boolean := False;
      --  set GPIO input_sync1 signal mode. :disable. 1:trigger at negedge.
      --  2or3:trigger at posedge.
      PIN_SYNC1_BYPASS  : PIN_PIN_SYNC1_BYPASS_Field := 16#0#;
      --  unspecified
      Reserved_5_6      : ESP32C3_SVD.UInt2 := 16#0#;
      --  set this value to choose interrupt mode. :disable GPIO interrupt.
      --  1:trigger at posedge. 2:trigger at negedge. 3:trigger at any edge.
      --  4:valid at low level. 5:valid at high level
      PIN_INT_TYPE      : PIN_PIN_INT_TYPE_Field := 16#0#;
      --  set this bit to enable GPIO wakeup.(can only wakeup CPU from
      --  Light-sleep Mode)
      PIN_WAKEUP_ENABLE : Boolean := False;
      --  reserved
      PIN_CONFIG        : PIN_PIN_CONFIG_Field := 16#0#;
      --  set bit 13 to enable CPU interrupt. set bit 14 to enable CPU(not
      --  shielded) interrupt.
      PIN_INT_ENA       : PIN_PIN_INT_ENA_Field := 16#0#;
      --  unspecified
   ...
   for PIN_Register use record
      PIN_SYNC2_BYPASS  at 0 range 0 .. 1;
      PIN_PAD_DRIVER    at 0 range 2 .. 2;
      PIN_SYNC1_BYPASS  at 0 range 3 .. 4;
      Reserved_5_6      at 0 range 5 .. 6;
      PIN_INT_TYPE      at 0 range 7 .. 9;
      PIN_WAKEUP_ENABLE at 0 range 10 .. 10;
      PIN_CONFIG        at 0 range 11 .. 12;
      PIN_INT_ENA       at 0 range 13 .. 17;
   ...
   subtype STATUS_NEXT_STATUS_INTERRUPT_NEXT_Field is ESP32C3_SVD.UInt26;
   ...
   subtype FUNC_IN_SEL_CFG_IN_SEL_Field is ESP32C3_SVD.UInt5;

   --  GPIO input function configuration register
   type FUNC_IN_SEL_CFG_Register is record
      --  set this value: s=-53: connect GPIO[s] to this port. s=x38: set this
      --  port always high level. s=x3C: set this port always low level.
   ...
   subtype FUNC_OUT_SEL_CFG_OUT_SEL_Field is ESP32C3_SVD.UInt8;

   --  GPIO output function select register
   type FUNC_OUT_SEL_CFG_Register is record
      --  The value of the bits: <=s<=256. Set the value to select output
      --  signal. s=-255: output of GPIO[n] equals input of peripheral[s].
   ...
   subtype REG_DATE_REG_DATE_Field is ESP32C3_SVD.UInt28;
   ...
   type GPIO_Peripheral is record
      ...
      BT_SELECT        : aliased ESP32C3_SVD.UInt32;
      --  GPIO output register
