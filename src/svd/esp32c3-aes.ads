...
package ESP32C3.AES is
   ...
   subtype MODE_MODE_Field is HAL.UInt3;
   ...
   subtype ENDIAN_ENDIAN_Field is HAL.UInt6;
   ...
   subtype STATE_STATE_Field is HAL.UInt2;
   ...
   --  The memory that stores initialization vector
   type IV_MEM_Registers is array (0 .. 15) of HAL.Byte;

   --  The memory that stores GCM hash subkey

   --  The memory that stores GCM hash subkey
   type H_MEM_Registers is array (0 .. 15) of HAL.Byte;

   --  The memory that stores J0

   --  The memory that stores J0
   type J0_MEM_Registers is array (0 .. 15) of HAL.Byte;

   --  The memory that stores T0

   --  The memory that stores T0
   type T0_MEM_Registers is array (0 .. 15) of HAL.Byte;
   ...
   subtype BLOCK_MODE_BLOCK_MODE_Field is HAL.UInt3;
   ...
   subtype REMAINDER_BIT_NUM_REMAINDER_BIT_NUM_Field is HAL.UInt7;
   ...
   subtype DATE_DATE_Field is HAL.UInt30;
