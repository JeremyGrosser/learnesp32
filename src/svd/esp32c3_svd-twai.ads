...
package ESP32C3_SVD.TWAI is
   ...
   type STATUS_Register is record
      ...
      MISS_ST       : Boolean;
      --  unspecified
      Reserved_9_31 : ESP32C3_SVD.UInt23;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type INT_RAW_Register is record
      ...
      OVERRUN_INT_ST     : Boolean;
      --  unspecified
      Reserved_4_4       : ESP32C3_SVD.Bit;
   ...
   type INT_ENA_Register is record
      ...
      ARB_LOST_INT_ENA    : Boolean := False;
   ...
   subtype BUS_TIMING_0_BAUD_PRESC_Field is ESP32C3_SVD.UInt13;
   subtype BUS_TIMING_0_SYNC_JUMP_WIDTH_Field is ESP32C3_SVD.UInt2;
   ...
   type BUS_TIMING_0_Register is record
      ...
      --  unspecified
      Reserved_13_13  : ESP32C3_SVD.Bit := 16#0#;
   ...
   for BUS_TIMING_0_Register use record
      BAUD_PRESC      at 0 range 0 .. 12;
      Reserved_13_13  at 0 range 13 .. 13;
      SYNC_JUMP_WIDTH at 0 range 14 .. 15;
      Reserved_16_31  at 0 range 16 .. 31;
   end record;

   subtype BUS_TIMING_1_TIME_SEG1_Field is ESP32C3_SVD.UInt4;
   subtype BUS_TIMING_1_TIME_SEG2_Field is ESP32C3_SVD.UInt3;
   ...
   subtype ARB_LOST_CAP_ARB_LOST_CAP_Field is ESP32C3_SVD.UInt5;
   ...
   subtype ERR_CODE_CAP_ECC_SEGMENT_Field is ESP32C3_SVD.UInt5;
   subtype ERR_CODE_CAP_ECC_TYPE_Field is ESP32C3_SVD.UInt2;
   ...
   subtype ERR_WARNING_LIMIT_ERR_WARNING_LIMIT_Field is ESP32C3_SVD.UInt8;
   ...
   subtype RX_ERR_CNT_RX_ERR_CNT_Field is ESP32C3_SVD.UInt8;
   ...
   subtype TX_ERR_CNT_TX_ERR_CNT_Field is ESP32C3_SVD.UInt8;
   ...
   subtype DATA_0_TX_BYTE_0_Field is ESP32C3_SVD.UInt8;

   --  Data register 0
   type DATA_0_Register is record
      --  Write-only. In reset mode, it is acceptance code register 0 with R/W
      --  Permission. In operation mode, it stores the 0th byte information of
   ...
   subtype DATA_1_TX_BYTE_1_Field is ESP32C3_SVD.UInt8;

   --  Data register 1
   type DATA_1_Register is record
      --  Write-only. In reset mode, it is acceptance code register 1 with R/W
      --  Permission. In operation mode, it stores the 1st byte information of
      --  the data to be transmitted under operating mode.
   ...
   subtype DATA_2_TX_BYTE_2_Field is ESP32C3_SVD.UInt8;

   --  Data register 2
   type DATA_2_Register is record
      --  Write-only. In reset mode, it is acceptance code register 2 with R/W
      --  Permission. In operation mode, it stores the 2nd byte information of
      --  the data to be transmitted under operating mode.
   ...
   subtype DATA_3_TX_BYTE_3_Field is ESP32C3_SVD.UInt8;

   --  Data register 3
   type DATA_3_Register is record
      --  Write-only. In reset mode, it is acceptance code register 3 with R/W
      --  Permission. In operation mode, it stores the 3rd byte information of
      --  the data to be transmitted under operating mode.
   ...
   subtype DATA_4_TX_BYTE_4_Field is ESP32C3_SVD.UInt8;

   --  Data register 4
   type DATA_4_Register is record
      --  Write-only. In reset mode, it is acceptance mask register 0 with R/W
      --  Permission. In operation mode, it stores the 4th byte information of
      --  the data to be transmitted under operating mode.
   ...
   subtype DATA_5_TX_BYTE_5_Field is ESP32C3_SVD.UInt8;

   --  Data register 5
   type DATA_5_Register is record
      --  Write-only. In reset mode, it is acceptance mask register 1 with R/W
      --  Permission. In operation mode, it stores the 5th byte information of
      --  the data to be transmitted under operating mode.
   ...
   subtype DATA_6_TX_BYTE_6_Field is ESP32C3_SVD.UInt8;

   --  Data register 6
   type DATA_6_Register is record
      --  Write-only. In reset mode, it is acceptance mask register 2 with R/W
      --  Permission. In operation mode, it stores the 6th byte information of
      --  the data to be transmitted under operating mode.
   ...
   subtype DATA_7_TX_BYTE_7_Field is ESP32C3_SVD.UInt8;

   --  Data register 7
   type DATA_7_Register is record
      --  Write-only. In reset mode, it is acceptance mask register 3 with R/W
      --  Permission. In operation mode, it stores the 7th byte information of
      --  the data to be transmitted under operating mode.
   ...
   subtype DATA_8_TX_BYTE_8_Field is ESP32C3_SVD.UInt8;

   --  Data register 8
   type DATA_8_Register is record
      --  Write-only. Stored the 8th byte information of the data to be
   ...
   subtype DATA_9_TX_BYTE_9_Field is ESP32C3_SVD.UInt8;

   --  Data register 9
   type DATA_9_Register is record
      --  Write-only. Stored the 9th byte information of the data to be
      --  transmitted under operating mode.
   ...
   subtype DATA_10_TX_BYTE_10_Field is ESP32C3_SVD.UInt8;

   --  Data register 10
   type DATA_10_Register is record
      --  Write-only. Stored the 10th byte information of the data to be
      --  transmitted under operating mode.
   ...
   subtype DATA_11_TX_BYTE_11_Field is ESP32C3_SVD.UInt8;

   --  Data register 11
   type DATA_11_Register is record
      --  Write-only. Stored the 11th byte information of the data to be
      --  transmitted under operating mode.
   ...
   subtype DATA_12_TX_BYTE_12_Field is ESP32C3_SVD.UInt8;

   --  Data register 12
   type DATA_12_Register is record
      --  Write-only. Stored the 12th byte information of the data to be
      --  transmitted under operating mode.
   ...
   subtype RX_MESSAGE_CNT_RX_MESSAGE_COUNTER_Field is ESP32C3_SVD.UInt7;
   ...
   subtype CLOCK_DIVIDER_CD_Field is ESP32C3_SVD.UInt8;
   ...
   --  Two-Wire Automotive Interface
   TWAI_Periph : aliased TWAI_Peripheral
     with Import, Address => TWAI_Base;

end ESP32C3_SVD.TWAI;
