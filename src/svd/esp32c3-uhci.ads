...
package ESP32C3.UHCI is
   ...
   subtype HUNG_CONF_TXFIFO_TIMEOUT_Field is HAL.Byte;
   subtype HUNG_CONF_TXFIFO_TIMEOUT_SHIFT_Field is HAL.UInt3;
   subtype HUNG_CONF_RXFIFO_TIMEOUT_Field is HAL.Byte;
   ...
   subtype ESC_CONF0_SEPER_CHAR_Field is HAL.Byte;
   --  ESC_CONF0_SEPER_ESC_CHAR array element
   subtype ESC_CONF0_SEPER_ESC_CHAR_Element is HAL.Byte;
   ...
   subtype ESC_CONF1_ESC_SEQ0_Field is HAL.Byte;
   --  ESC_CONF1_ESC_SEQ0_CHAR array element
   subtype ESC_CONF1_ESC_SEQ0_CHAR_Element is HAL.Byte;
   ...
   subtype ESC_CONF2_ESC_SEQ1_Field is HAL.Byte;
   --  ESC_CONF2_ESC_SEQ1_CHAR array element
   subtype ESC_CONF2_ESC_SEQ1_CHAR_Element is HAL.Byte;
   ...
   subtype ESC_CONF3_ESC_SEQ2_Field is HAL.Byte;
   --  ESC_CONF3_ESC_SEQ2_CHAR array element
   subtype ESC_CONF3_ESC_SEQ2_CHAR_Element is HAL.Byte;
