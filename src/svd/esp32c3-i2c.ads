...
package ESP32C3.I2C is
   ...
   subtype SCL_LOW_PERIOD_SCL_LOW_PERIOD_Field is HAL.UInt9;
   ...
   subtype SR_RXFIFO_CNT_Field is HAL.UInt6;
   subtype SR_STRETCH_CAUSE_Field is HAL.UInt2;
   subtype SR_TXFIFO_CNT_Field is HAL.UInt6;
   subtype SR_SCL_MAIN_STATE_LAST_Field is HAL.UInt3;
   subtype SR_SCL_STATE_LAST_Field is HAL.UInt3;
   ...
   subtype TO_TIME_OUT_VALUE_Field is HAL.UInt5;
   ...
   subtype SLAVE_ADDR_SLAVE_ADDR_Field is HAL.UInt15;
   ...
   subtype FIFO_ST_RXFIFO_RADDR_Field is HAL.UInt5;
   subtype FIFO_ST_RXFIFO_WADDR_Field is HAL.UInt5;
   subtype FIFO_ST_TXFIFO_RADDR_Field is HAL.UInt5;
   subtype FIFO_ST_TXFIFO_WADDR_Field is HAL.UInt5;
   subtype FIFO_ST_SLAVE_RW_POINT_Field is HAL.Byte;
   ...
   subtype FIFO_CONF_RXFIFO_WM_THRHD_Field is HAL.UInt5;
   subtype FIFO_CONF_TXFIFO_WM_THRHD_Field is HAL.UInt5;
   ...
   subtype DATA_FIFO_RDATA_Field is HAL.Byte;
   ...
   subtype SDA_HOLD_TIME_Field is HAL.UInt9;
   ...
   subtype SDA_SAMPLE_TIME_Field is HAL.UInt9;
   ...
   subtype SCL_HIGH_PERIOD_SCL_HIGH_PERIOD_Field is HAL.UInt9;
   subtype SCL_HIGH_PERIOD_SCL_WAIT_HIGH_PERIOD_Field is HAL.UInt7;
   ...
   subtype SCL_START_HOLD_TIME_Field is HAL.UInt9;
   ...
   subtype SCL_RSTART_SETUP_TIME_Field is HAL.UInt9;
   ...
   subtype SCL_STOP_HOLD_TIME_Field is HAL.UInt9;
   ...
   subtype SCL_STOP_SETUP_TIME_Field is HAL.UInt9;
   ...
   subtype FILTER_CFG_SCL_FILTER_THRES_Field is HAL.UInt4;
   subtype FILTER_CFG_SDA_FILTER_THRES_Field is HAL.UInt4;
   ...
   subtype CLK_CONF_SCLK_DIV_NUM_Field is HAL.Byte;
   ...
   subtype COMD_COMMAND_Field is HAL.UInt14;
   ...
   subtype SCL_ST_TIME_OUT_SCL_ST_TO_I2C_Field is HAL.UInt5;
   ...
   subtype SCL_MAIN_ST_TIME_OUT_SCL_MAIN_ST_TO_I2C_Field is HAL.UInt5;
   ...
   subtype SCL_SP_CONF_SCL_RST_SLV_NUM_Field is HAL.UInt5;
   ...
   subtype SCL_STRETCH_CONF_STRETCH_PROTECT_NUM_Field is HAL.UInt10;
   ...
   type I2C0_Peripheral is record
      ...
      TXFIFO_START_ADDR    : aliased HAL.UInt32;
      --  I2C_RXFIFO_START_ADDR_REG
      RXFIFO_START_ADDR    : aliased HAL.UInt32;
   end record
     with Volatile;
