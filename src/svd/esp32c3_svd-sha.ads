...
package ESP32C3_SVD.SHA is
   ...
   subtype T_LENGTH_T_LENGTH_Field is ESP32C3_SVD.UInt6;
   ...
   subtype DMA_BLOCK_NUM_DMA_BLOCK_NUM_Field is ESP32C3_SVD.UInt6;
   ...
   subtype START_START_Field is ESP32C3_SVD.UInt31;

   --  Typical SHA configuration register 0.
   type START_Register is record
      --  unspecified
      Reserved_0_0 : ESP32C3_SVD.Bit;
      --  Read-only. Reserved.
      START        : START_START_Field;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CONTINUE_CONTINUE_Field is ESP32C3_SVD.UInt31;
   ...
   type CONTINUE_Register is record
      ...
      Reserved_0_0 : ESP32C3_SVD.Bit;
      --  Read-only. Reserved.
      CONTINUE     : CONTINUE_CONTINUE_Field;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   --  Sha H memory which contains intermediate hash or finial hash.
   type H_MEM_Registers is array (0 .. 63) of ESP32C3_SVD.UInt8;

   --  Sha M memory which contains message.

   --  Sha M memory which contains message.
   type M_MEM_Registers is array (0 .. 63) of ESP32C3_SVD.UInt8;
   ...
   type SHA_Peripheral is record
      ...
      T_STRING      : aliased ESP32C3_SVD.UInt32;
      --  SHA 512/t configuration register 1.
