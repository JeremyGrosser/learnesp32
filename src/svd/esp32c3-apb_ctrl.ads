...
package ESP32C3.APB_CTRL is
   ...
   subtype SYSCLK_CONF_PRE_DIV_CNT_Field is HAL.UInt10;
   ...
   subtype TICK_CONF_XTAL_TICK_NUM_Field is HAL.Byte;
   subtype TICK_CONF_CK8M_TICK_NUM_Field is HAL.Byte;
   ...
   subtype HOST_INF_SEL_PERI_IO_SWAP_Field is HAL.Byte;
   ...
   subtype FLASH_ACE0_ATTR_FLASH_ACE0_ATTR_Field is HAL.UInt2;
   ...
   subtype FLASH_ACE1_ATTR_FLASH_ACE1_ATTR_Field is HAL.UInt2;
   ...
   subtype FLASH_ACE2_ATTR_FLASH_ACE2_ATTR_Field is HAL.UInt2;
   ...
   subtype FLASH_ACE3_ATTR_FLASH_ACE3_ATTR_Field is HAL.UInt2;
   ...
   subtype FLASH_ACE0_SIZE_FLASH_ACE0_SIZE_Field is HAL.UInt13;
   ...
   subtype FLASH_ACE1_SIZE_FLASH_ACE1_SIZE_Field is HAL.UInt13;
   ...
   subtype FLASH_ACE2_SIZE_FLASH_ACE2_SIZE_Field is HAL.UInt13;
   ...
   subtype FLASH_ACE3_SIZE_FLASH_ACE3_SIZE_Field is HAL.UInt13;
   ...
   subtype SPI_MEM_PMS_CTRL_SPI_MEM_REJECT_CDE_Field is HAL.UInt5;
   ...
   subtype REDCY_SIG0_REDCY_SIG0_Field is HAL.UInt31;
   ...
   subtype REDCY_SIG1_REDCY_SIG1_Field is HAL.UInt31;
   ...
   subtype RETENTION_CTRL_RETENTION_LINK_ADDR_Field is HAL.UInt27;
   ...
   subtype CLKGATE_FORCE_ON_ROM_CLKGATE_FORCE_ON_Field is HAL.UInt2;
   subtype CLKGATE_FORCE_ON_SRAM_CLKGATE_FORCE_ON_Field is HAL.UInt4;
   ...
   subtype MEM_POWER_DOWN_ROM_POWER_DOWN_Field is HAL.UInt2;
   subtype MEM_POWER_DOWN_SRAM_POWER_DOWN_Field is HAL.UInt4;
   ...
   subtype MEM_POWER_UP_ROM_POWER_UP_Field is HAL.UInt2;
   subtype MEM_POWER_UP_SRAM_POWER_UP_Field is HAL.UInt4;
   ...
   subtype PERI_BACKUP_CONFIG_PERI_BACKUP_FLOW_ERR_Field is HAL.UInt2;
   subtype PERI_BACKUP_CONFIG_PERI_BACKUP_BURST_LIMIT_Field is HAL.UInt5;
   subtype PERI_BACKUP_CONFIG_PERI_BACKUP_TOUT_THRES_Field is HAL.UInt10;
   subtype PERI_BACKUP_CONFIG_PERI_BACKUP_SIZE_Field is HAL.UInt10;
   ...
   type APB_CTRL_Peripheral is record
      ...
      WIFI_BB_CFG_2        : aliased HAL.UInt32;
      --  APB_CTRL_WIFI_CLK_EN_REG
      WIFI_CLK_EN          : aliased HAL.UInt32;
      --  APB_CTRL_WIFI_RST_EN_REG
      WIFI_RST_EN          : aliased HAL.UInt32;
      --  APB_CTRL_HOST_INF_SEL_REG
      ...
      FLASH_ACE0_ADDR      : aliased HAL.UInt32;
      --  APB_CTRL_FLASH_ACE1_ADDR_REG
      FLASH_ACE1_ADDR      : aliased HAL.UInt32;
      --  APB_CTRL_FLASH_ACE2_ADDR_REG
      FLASH_ACE2_ADDR      : aliased HAL.UInt32;
      --  APB_CTRL_FLASH_ACE3_ADDR_REG
      FLASH_ACE3_ADDR      : aliased HAL.UInt32;
      --  APB_CTRL_FLASH_ACE0_SIZE_REG
      ...
      SPI_MEM_REJECT_ADDR  : aliased HAL.UInt32;
      --  APB_CTRL_SDIO_CTRL_REG
