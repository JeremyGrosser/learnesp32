...
package ESP32C3_SVD.SPI0 is
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_9_12  : ESP32C3_SVD.UInt4 := 16#0#;
      ...
      --  unspecified
      Reserved_15_17 : ESP32C3_SVD.UInt3 := 16#0#;
      ...
      WP             : Boolean := True;
      --  unspecified
      Reserved_22_22 : ESP32C3_SVD.Bit := 16#0#;
   ...
   type CTRL1_Register is record
      ...
      --  unspecified
      Reserved_2_29  : ESP32C3_SVD.UInt28 := 16#0#;
   ...
   subtype CTRL2_CS_SETUP_TIME_Field is ESP32C3_SVD.UInt5;
   subtype CTRL2_CS_HOLD_TIME_Field is ESP32C3_SVD.UInt5;
   subtype CTRL2_CS_HOLD_DELAY_Field is ESP32C3_SVD.UInt6;
   ...
   type CTRL2_Register is record
      ...
      --  unspecified
      Reserved_10_24 : ESP32C3_SVD.UInt15 := 16#0#;
   ...
   type MISC_Register is record
      ...
      TRANS_END_INT_ENA         : Boolean := False;
      --  The bit is used to indicate the spi0_slv_st controlled transmitting
      --  is done.
      CSPI_ST_TRANS_END         : Boolean := False;
      --  The bit is used to enable the interrupt of spi0_slv_st controlled
      --  transmitting is done.
      CSPI_ST_TRANS_END_INT_ENA : Boolean := False;
      --  unspecified
      Reserved_7_8              : ESP32C3_SVD.UInt2 := 16#0#;
   ...
   type CACHE_FCTRL_Register is record
      ...
      --  0:disable.
      CACHE_FLASH_USR_CMD  : Boolean := False;
   ...
   subtype FSM_CSPI_ST_Field is ESP32C3_SVD.UInt4;
   subtype FSM_EM_ST_Field is ESP32C3_SVD.UInt3;
   subtype FSM_CSPI_LOCK_DELAY_TIME_Field is ESP32C3_SVD.UInt5;
   ...
   subtype CORE_CLK_SEL_SPI01_CLK_SEL_Field is ESP32C3_SVD.UInt2;
