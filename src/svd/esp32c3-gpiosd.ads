...
package ESP32C3.GPIOSD is
   ...
   subtype SIGMADELTA_SD0_IN_Field is HAL.Byte;
   subtype SIGMADELTA_SD0_PRESCALE_Field is HAL.Byte;
   ...
   subtype SIGMADELTA_VERSION_GPIO_SD_DATE_Field is HAL.UInt28;
