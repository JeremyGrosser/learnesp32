...
package ESP32C3_SVD.APB_CTRL is
   pragma Preelaborate;
   ...
   subtype TICK_CONF_XTAL_TICK_NUM_Field is ESP32C3_SVD.UInt8;
   subtype TICK_CONF_CK8M_TICK_NUM_Field is ESP32C3_SVD.UInt8;
   ...
   subtype HOST_INF_SEL_PERI_IO_SWAP_Field is ESP32C3_SVD.UInt8;
   ...
   type EXT_MEM_PMS_LOCK_Register is record
      ...
      EXT_MEM_PMS_LOCK : Boolean := False;
      --  unspecified
   ...
   subtype FLASH_ACE0_ATTR_FLASH_ACE0_ATTR_Field is ESP32C3_SVD.UInt2;
   ...
   subtype FLASH_ACE1_ATTR_FLASH_ACE1_ATTR_Field is ESP32C3_SVD.UInt2;
   ...
   subtype FLASH_ACE2_ATTR_FLASH_ACE2_ATTR_Field is ESP32C3_SVD.UInt2;
   ...
   subtype FLASH_ACE3_ATTR_FLASH_ACE3_ATTR_Field is ESP32C3_SVD.UInt2;
   ...
   subtype FLASH_ACE0_SIZE_FLASH_ACE0_SIZE_Field is ESP32C3_SVD.UInt13;
   ...
   subtype FLASH_ACE1_SIZE_FLASH_ACE1_SIZE_Field is ESP32C3_SVD.UInt13;
   ...
   subtype FLASH_ACE2_SIZE_FLASH_ACE2_SIZE_Field is ESP32C3_SVD.UInt13;
   ...
   subtype FLASH_ACE3_SIZE_FLASH_ACE3_SIZE_Field is ESP32C3_SVD.UInt13;
   ...
   subtype SPI_MEM_PMS_CTRL_SPI_MEM_REJECT_CDE_Field is ESP32C3_SVD.UInt5;

   --  APB_CTRL_SPI_MEM_PMS_CTRL_REG
   type SPI_MEM_PMS_CTRL_Register is record
      --  Read-only. reg_spi_mem_reject_int
      SPI_MEM_REJECT_INT : Boolean := False;
      --  Write-only. reg_spi_mem_reject_clr
      SPI_MEM_REJECT_CLR : Boolean := False;
   ...
   type SDIO_CTRL_Register is record
      ...
      SDIO_WIN_ACCESS_EN : Boolean := False;
      --  unspecified
      Reserved_1_31      : ESP32C3_SVD.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype REDCY_SIG0_REDCY_SIG0_Field is ESP32C3_SVD.UInt31;
   ...
   subtype REDCY_SIG1_REDCY_SIG1_Field is ESP32C3_SVD.UInt31;
   ...
   subtype RETENTION_CTRL_RETENTION_LINK_ADDR_Field is ESP32C3_SVD.UInt27;
   ...
   type RETENTION_CTRL_Register is record
      ...
      NOBYPASS_CPU_ISO_RST : Boolean := False;
      --  unspecified
   ...
   subtype CLKGATE_FORCE_ON_ROM_CLKGATE_FORCE_ON_Field is ESP32C3_SVD.UInt2;
   subtype CLKGATE_FORCE_ON_SRAM_CLKGATE_FORCE_ON_Field is ESP32C3_SVD.UInt4;
   ...
   subtype MEM_POWER_DOWN_ROM_POWER_DOWN_Field is ESP32C3_SVD.UInt2;
   subtype MEM_POWER_DOWN_SRAM_POWER_DOWN_Field is ESP32C3_SVD.UInt4;
   ...
   subtype MEM_POWER_UP_ROM_POWER_UP_Field is ESP32C3_SVD.UInt2;
   subtype MEM_POWER_UP_SRAM_POWER_UP_Field is ESP32C3_SVD.UInt4;
   ...
   subtype PERI_BACKUP_CONFIG_PERI_BACKUP_FLOW_ERR_Field is ESP32C3_SVD.UInt2;
   subtype PERI_BACKUP_CONFIG_PERI_BACKUP_BURST_LIMIT_Field is
     ESP32C3_SVD.UInt5;
   subtype PERI_BACKUP_CONFIG_PERI_BACKUP_TOUT_THRES_Field is
     ESP32C3_SVD.UInt10;
   subtype PERI_BACKUP_CONFIG_PERI_BACKUP_SIZE_Field is ESP32C3_SVD.UInt10;
   ...
   type PERI_BACKUP_CONFIG_Register is record
      ...
      PERI_BACKUP_START       : Boolean := False;
      --  reg_peri_backup_to_mem
      PERI_BACKUP_TO_MEM      : Boolean := False;
      --  reg_peri_backup_ena
      PERI_BACKUP_ENA         : Boolean := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type PERI_BACKUP_INT_RAW_Register is record
      ...
      PERI_BACKUP_DONE_INT_RAW : Boolean;
      --  Read-only. reg_peri_backup_err_int_raw
      PERI_BACKUP_ERR_INT_RAW  : Boolean;
      --  unspecified
   ...
   type PERI_BACKUP_INT_ST_Register is record
      ...
      PERI_BACKUP_DONE_INT_ST : Boolean;
      --  Read-only. reg_peri_backup_err_int_st
      PERI_BACKUP_ERR_INT_ST  : Boolean;
      --  unspecified
      Reserved_2_31           : ESP32C3_SVD.UInt30;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type PERI_BACKUP_INT_ENA_Register is record
      ...
      PERI_BACKUP_DONE_INT_ENA : Boolean := False;
      --  reg_peri_backup_err_int_ena
      PERI_BACKUP_ERR_INT_ENA  : Boolean := False;
      --  unspecified
      Reserved_2_31            : ESP32C3_SVD.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type PERI_BACKUP_INT_CLR_Register is record
      ...
      PERI_BACKUP_DONE_INT_CLR : Boolean := False;
      --  Write-only. reg_peri_backup_err_int_clr
      PERI_BACKUP_ERR_INT_CLR  : Boolean := False;
      --  unspecified
      Reserved_2_31            : ESP32C3_SVD.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type APB_CTRL_Peripheral is record
      ...
      WIFI_BB_CFG          : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_WIFI_BB_CFG_2_REG
      WIFI_BB_CFG_2        : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_WIFI_CLK_EN_REG
      WIFI_CLK_EN          : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_WIFI_RST_EN_REG
      WIFI_RST_EN          : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_HOST_INF_SEL_REG
      ...
      FLASH_ACE0_ADDR      : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_FLASH_ACE1_ADDR_REG
      FLASH_ACE1_ADDR      : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_FLASH_ACE2_ADDR_REG
      FLASH_ACE2_ADDR      : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_FLASH_ACE3_ADDR_REG
      FLASH_ACE3_ADDR      : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_FLASH_ACE0_SIZE_REG
      ...
      SPI_MEM_REJECT_ADDR  : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_SDIO_CTRL_REG
      ...
      RND_DATA             : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_PERI_BACKUP_CONFIG_REG
      PERI_BACKUP_CONFIG   : aliased PERI_BACKUP_CONFIG_Register;
      --  APB_CTRL_PERI_BACKUP_APB_ADDR_REG
      PERI_BACKUP_APB_ADDR : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_PERI_BACKUP_MEM_ADDR_REG
      PERI_BACKUP_MEM_ADDR : aliased ESP32C3_SVD.UInt32;
      --  APB_CTRL_PERI_BACKUP_INT_RAW_REG
