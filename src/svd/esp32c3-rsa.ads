...
package ESP32C3.RSA is
   ...
   --  The memory that stores M
   type M_MEM_Registers is array (0 .. 15) of HAL.Byte;

   --  The memory that stores Z

   --  The memory that stores Z
   type Z_MEM_Registers is array (0 .. 15) of HAL.Byte;

   --  The memory that stores Y

   --  The memory that stores Y
   type Y_MEM_Registers is array (0 .. 15) of HAL.Byte;

   --  The memory that stores X

   --  The memory that stores X
   type X_MEM_Registers is array (0 .. 15) of HAL.Byte;

   subtype MODE_MODE_Field is HAL.UInt7;
   ...
   subtype SEARCH_POS_SEARCH_POS_Field is HAL.UInt12;
