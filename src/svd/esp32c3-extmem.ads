...
package ESP32C3.EXTMEM is
   ...
   subtype ICACHE_LOCK_SIZE_ICACHE_LOCK_SIZE_Field is HAL.UInt16;
   ...
   subtype ICACHE_SYNC_SIZE_ICACHE_SYNC_SIZE_Field is HAL.UInt23;
   ...
   subtype ICACHE_PRELOAD_SIZE_ICACHE_PRELOAD_SIZE_Field is HAL.UInt16;
   ...
   subtype ICACHE_AUTOLOAD_CTRL_ICACHE_AUTOLOAD_RQST_Field is HAL.UInt2;
   ...
   subtype CORE0_DBUS_REJECT_ST_CORE0_DBUS_ATTR_Field is HAL.UInt3;
   ...
   subtype CORE0_IBUS_REJECT_ST_CORE0_IBUS_ATTR_Field is HAL.UInt3;
   ...
   subtype CACHE_MMU_FAULT_CONTENT_CACHE_MMU_FAULT_CONTENT_Field is HAL.UInt10;
   subtype CACHE_MMU_FAULT_CONTENT_CACHE_MMU_FAULT_CODE_Field is HAL.UInt4;
   ...
   subtype CACHE_STATE_ICACHE_STATE_Field is HAL.UInt12;
   ...
   subtype CACHE_MMU_OWNER_CACHE_MMU_OWNER_Field is HAL.UInt4;
   ...
   subtype IBUS_PMS_TBL_BOUNDARY0_IBUS_PMS_BOUNDARY0_Field is HAL.UInt12;
   ...
   subtype IBUS_PMS_TBL_BOUNDARY1_IBUS_PMS_BOUNDARY1_Field is HAL.UInt12;
   ...
   subtype IBUS_PMS_TBL_BOUNDARY2_IBUS_PMS_BOUNDARY2_Field is HAL.UInt12;
   ...
   subtype IBUS_PMS_TBL_ATTR_IBUS_PMS_SCT1_ATTR_Field is HAL.UInt4;
   subtype IBUS_PMS_TBL_ATTR_IBUS_PMS_SCT2_ATTR_Field is HAL.UInt4;
   ...
   subtype DBUS_PMS_TBL_BOUNDARY0_DBUS_PMS_BOUNDARY0_Field is HAL.UInt12;
   ...
   subtype DBUS_PMS_TBL_BOUNDARY1_DBUS_PMS_BOUNDARY1_Field is HAL.UInt12;
   ...
   subtype DBUS_PMS_TBL_BOUNDARY2_DBUS_PMS_BOUNDARY2_Field is HAL.UInt12;
   ...
   subtype DBUS_PMS_TBL_ATTR_DBUS_PMS_SCT1_ATTR_Field is HAL.UInt2;
   subtype DBUS_PMS_TBL_ATTR_DBUS_PMS_SCT2_ATTR_Field is HAL.UInt2;
   ...
   subtype REG_DATE_DATE_Field is HAL.UInt28;
   ...
   type EXTMEM_Peripheral is record
      ...
      --  This description will be updated in the near future.
      CORE0_DBUS_REJECT_VADDR              : aliased HAL.UInt32;
      --  This description will be updated in the near future.
      CORE0_IBUS_REJECT_ST                 : aliased CORE0_IBUS_REJECT_ST_Register;
      --  This description will be updated in the near future.
      CORE0_IBUS_REJECT_VADDR              : aliased HAL.UInt32;
      --  This description will be updated in the near future.
      CACHE_MMU_FAULT_CONTENT              : aliased CACHE_MMU_FAULT_CONTENT_Register;
      --  This description will be updated in the near future.
      CACHE_MMU_FAULT_VADDR                : aliased HAL.UInt32;
      --  This description will be updated in the near future.
