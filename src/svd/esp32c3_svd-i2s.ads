...
package ESP32C3_SVD.I2S is
   ...
   subtype RX_CONF_RX_PCM_CONF_Field is ESP32C3_SVD.UInt2;
   subtype RX_CONF_RX_STOP_MODE_Field is ESP32C3_SVD.UInt2;

   --  I2S RX configure register
   type RX_CONF_Register is record
      --  Write-only. Set this bit to reset receiver
      RX_RESET        : Boolean := False;
   ...
   subtype TX_CONF_TX_PCM_CONF_Field is ESP32C3_SVD.UInt2;
   subtype TX_CONF_TX_CHAN_MOD_Field is ESP32C3_SVD.UInt3;

   --  I2S TX configure register
   type TX_CONF_Register is record
      --  Write-only. Set this bit to reset transmitter
      TX_RESET        : Boolean := False;
      ...
      TX_SLAVE_MOD    : Boolean := False;
      --  unspecified
      Reserved_4_4    : ESP32C3_SVD.Bit := 16#0#;
      --  Set this bit to enable transmitter in mono mode
      TX_MONO         : Boolean := False;
   ...
   subtype RX_CONF1_RX_TDM_WS_WIDTH_Field is ESP32C3_SVD.UInt7;
   subtype RX_CONF1_RX_BCK_DIV_NUM_Field is ESP32C3_SVD.UInt6;
   subtype RX_CONF1_RX_BITS_MOD_Field is ESP32C3_SVD.UInt5;
   subtype RX_CONF1_RX_HALF_SAMPLE_BITS_Field is ESP32C3_SVD.UInt6;
   subtype RX_CONF1_RX_TDM_CHAN_BITS_Field is ESP32C3_SVD.UInt5;
   ...
   subtype TX_CONF1_TX_TDM_WS_WIDTH_Field is ESP32C3_SVD.UInt7;
   subtype TX_CONF1_TX_BCK_DIV_NUM_Field is ESP32C3_SVD.UInt6;
   subtype TX_CONF1_TX_BITS_MOD_Field is ESP32C3_SVD.UInt5;
   subtype TX_CONF1_TX_HALF_SAMPLE_BITS_Field is ESP32C3_SVD.UInt6;
   subtype TX_CONF1_TX_TDM_CHAN_BITS_Field is ESP32C3_SVD.UInt5;
   ...
   subtype RX_CLKM_CONF_RX_CLKM_DIV_NUM_Field is ESP32C3_SVD.UInt8;
   subtype RX_CLKM_CONF_RX_CLK_SEL_Field is ESP32C3_SVD.UInt2;
   ...
   type RX_CLKM_CONF_Register is record
      ...
      --  unspecified
      Reserved_8_25   : ESP32C3_SVD.UInt18 := 16#0#;
      --  I2S Rx module clock enable signal.
      RX_CLK_ACTIVE   : Boolean := False;
   ...
   subtype TX_CLKM_CONF_TX_CLKM_DIV_NUM_Field is ESP32C3_SVD.UInt8;
   subtype TX_CLKM_CONF_TX_CLK_SEL_Field is ESP32C3_SVD.UInt2;
   ...
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_Z_Field is ESP32C3_SVD.UInt9;
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_Y_Field is ESP32C3_SVD.UInt9;
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_X_Field is ESP32C3_SVD.UInt9;
   ...
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_Z_Field is ESP32C3_SVD.UInt9;
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_Y_Field is ESP32C3_SVD.UInt9;
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_X_Field is ESP32C3_SVD.UInt9;
   ...
   subtype TX_PCM2PDM_CONF_TX_PDM_SINC_OSR2_Field is ESP32C3_SVD.UInt4;
   subtype TX_PCM2PDM_CONF_TX_PDM_PRESCALE_Field is ESP32C3_SVD.UInt8;
   subtype TX_PCM2PDM_CONF_TX_PDM_HP_IN_SHIFT_Field is ESP32C3_SVD.UInt2;
   subtype TX_PCM2PDM_CONF_TX_PDM_LP_IN_SHIFT_Field is ESP32C3_SVD.UInt2;
   subtype TX_PCM2PDM_CONF_TX_PDM_SINC_IN_SHIFT_Field is ESP32C3_SVD.UInt2;
   subtype TX_PCM2PDM_CONF_TX_PDM_SIGMADELTA_IN_SHIFT_Field is
     ESP32C3_SVD.UInt2;
   ...
   type TX_PCM2PDM_CONF_Register is record
      ...
      TX_PDM_HP_BYPASS           : Boolean := False;
      ...
      TX_PDM_SIGMADELTA_DITHER2  : Boolean := False;
      --  I2S TX PDM sigmadelta dither value
      TX_PDM_SIGMADELTA_DITHER   : Boolean := True;
      --  I2S TX PDM dac mode enable
      TX_PDM_DAC_2OUT_EN         : Boolean := False;
      --  I2S TX PDM dac 2channel enable
      TX_PDM_DAC_MODE_EN         : Boolean := False;
      --  I2S TX PDM Converter enable
      PCM2PDM_CONV_EN            : Boolean := False;
      --  unspecified
   ...
   subtype TX_PCM2PDM_CONF1_TX_PDM_FP_Field is ESP32C3_SVD.UInt10;
   subtype TX_PCM2PDM_CONF1_TX_PDM_FS_Field is ESP32C3_SVD.UInt10;
   subtype TX_PCM2PDM_CONF1_TX_IIR_HP_MULT12_5_Field is ESP32C3_SVD.UInt3;
   subtype TX_PCM2PDM_CONF1_TX_IIR_HP_MULT12_0_Field is ESP32C3_SVD.UInt3;
   ...
   subtype RX_TDM_CTRL_RX_TDM_TOT_CHAN_NUM_Field is ESP32C3_SVD.UInt4;
   ...
   subtype TX_TDM_CTRL_TX_TDM_TOT_CHAN_NUM_Field is ESP32C3_SVD.UInt4;
   ...
   type TX_TDM_CTRL_Register is record
      ...
      TX_TDM_SKIP_MSK_EN  : Boolean := False;
      --  unspecified
      Reserved_21_31      : ESP32C3_SVD.UInt11 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype RX_TIMING_RX_SD_IN_DM_Field is ESP32C3_SVD.UInt2;
   subtype RX_TIMING_RX_WS_OUT_DM_Field is ESP32C3_SVD.UInt2;
   subtype RX_TIMING_RX_BCK_OUT_DM_Field is ESP32C3_SVD.UInt2;
   subtype RX_TIMING_RX_WS_IN_DM_Field is ESP32C3_SVD.UInt2;
   subtype RX_TIMING_RX_BCK_IN_DM_Field is ESP32C3_SVD.UInt2;
   ...
   type RX_TIMING_Register is record
      ...
      --  unspecified
      Reserved_2_15  : ESP32C3_SVD.UInt14 := 16#0#;
   ...
   subtype TX_TIMING_TX_SD_OUT_DM_Field is ESP32C3_SVD.UInt2;
   subtype TX_TIMING_TX_SD1_OUT_DM_Field is ESP32C3_SVD.UInt2;
   subtype TX_TIMING_TX_WS_OUT_DM_Field is ESP32C3_SVD.UInt2;
   subtype TX_TIMING_TX_BCK_OUT_DM_Field is ESP32C3_SVD.UInt2;
   subtype TX_TIMING_TX_WS_IN_DM_Field is ESP32C3_SVD.UInt2;
   subtype TX_TIMING_TX_BCK_IN_DM_Field is ESP32C3_SVD.UInt2;
   ...
   subtype LC_HUNG_CONF_LC_FIFO_TIMEOUT_Field is ESP32C3_SVD.UInt8;
   subtype LC_HUNG_CONF_LC_FIFO_TIMEOUT_SHIFT_Field is ESP32C3_SVD.UInt3;
   ...
   type LC_HUNG_CONF_Register is record
      ...
      LC_FIFO_TIMEOUT_ENA   : Boolean := True;
      --  unspecified
   ...
   subtype RXEOF_NUM_RX_EOF_NUM_Field is ESP32C3_SVD.UInt12;
   ...
   type I2S_Peripheral is record
      ...
      CONF_SIGLE_DATA  : aliased ESP32C3_SVD.UInt32;
      --  I2S TX status register
