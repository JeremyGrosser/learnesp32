...
package ESP32C3.GPIO is
   ...
   subtype OUT_DATA_ORIG_Field is HAL.UInt26;
   ...
   subtype OUT_W1TS_OUT_W1TS_Field is HAL.UInt26;
   ...
   subtype OUT_W1TC_OUT_W1TC_Field is HAL.UInt26;
   ...
   subtype SDIO_SELECT_SDIO_SEL_Field is HAL.Byte;
   ...
   subtype ENABLE_DATA_Field is HAL.UInt26;
   ...
   subtype ENABLE_W1TS_ENABLE_W1TS_Field is HAL.UInt26;
   ...
   subtype ENABLE_W1TC_ENABLE_W1TC_Field is HAL.UInt26;
   ...
   subtype IN_DATA_NEXT_Field is HAL.UInt26;
   ...
   subtype STATUS_INTERRUPT_Field is HAL.UInt26;
   ...
   subtype STATUS_W1TS_STATUS_W1TS_Field is HAL.UInt26;
   ...
   subtype STATUS_W1TC_STATUS_W1TC_Field is HAL.UInt26;
   ...
   subtype PCPU_INT_PROCPU_INT_Field is HAL.UInt26;
   ...
   subtype PCPU_NMI_INT_PROCPU_NMI_INT_Field is HAL.UInt26;
   ...
   subtype CPUSDIO_INT_SDIO_INT_Field is HAL.UInt26;
   ...
   subtype PIN_PIN_SYNC2_BYPASS_Field is HAL.UInt2;
   subtype PIN_PIN_SYNC1_BYPASS_Field is HAL.UInt2;
   subtype PIN_PIN_INT_TYPE_Field is HAL.UInt3;
   subtype PIN_PIN_CONFIG_Field is HAL.UInt2;
   subtype PIN_PIN_INT_ENA_Field is HAL.UInt5;
   ...
   subtype STATUS_NEXT_STATUS_INTERRUPT_NEXT_Field is HAL.UInt26;
   ...
   subtype FUNC_IN_SEL_CFG_IN_SEL_Field is HAL.UInt5;
   ...
   subtype FUNC_OUT_SEL_CFG_OUT_SEL_Field is HAL.Byte;
   ...
   subtype REG_DATE_REG_DATE_Field is HAL.UInt28;
