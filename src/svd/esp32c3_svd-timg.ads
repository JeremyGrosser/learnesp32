...
package ESP32C3_SVD.TIMG is
   ...
   subtype T0CONFIG_T0_DIVIDER_Field is ESP32C3_SVD.UInt16;
   ...
   subtype T0HI_T0_HI_Field is ESP32C3_SVD.UInt22;
   ...
   subtype T0ALARMHI_T0_ALARM_HI_Field is ESP32C3_SVD.UInt22;
   ...
   subtype T0LOADHI_T0_LOAD_HI_Field is ESP32C3_SVD.UInt22;
   ...
   subtype WDTCONFIG0_WDT_STG3_Field is ESP32C3_SVD.UInt2;
   subtype WDTCONFIG0_WDT_STG2_Field is ESP32C3_SVD.UInt2;
   subtype WDTCONFIG0_WDT_STG1_Field is ESP32C3_SVD.UInt2;
   subtype WDTCONFIG0_WDT_STG0_Field is ESP32C3_SVD.UInt2;
   ...
   subtype WDTCONFIG1_WDT_CLK_PRESCALE_Field is ESP32C3_SVD.UInt16;
   ...
   type WDTCONFIG1_Register is record
      ...
      --  unspecified
      Reserved_1_15    : ESP32C3_SVD.UInt15 := 16#0#;
   ...
   subtype RTCCALICFG_RTC_CALI_CLK_SEL_Field is ESP32C3_SVD.UInt2;
   subtype RTCCALICFG_RTC_CALI_MAX_Field is ESP32C3_SVD.UInt15;
   ...
   subtype RTCCALICFG1_RTC_CALI_VALUE_Field is ESP32C3_SVD.UInt25;
   ...
   type RTCCALICFG1_Register is record
      ...
      --  unspecified
      Reserved_1_6              : ESP32C3_SVD.UInt6;
   ...
   subtype RTCCALICFG2_RTC_CALI_TIMEOUT_RST_CNT_Field is ESP32C3_SVD.UInt4;
   subtype RTCCALICFG2_RTC_CALI_TIMEOUT_THRES_Field is ESP32C3_SVD.UInt25;
   ...
   subtype NTIMG_DATE_NTIMGS_DATE_Field is ESP32C3_SVD.UInt28;
   ...
   type TIMG_Peripheral is record
      ...
      --  TIMG_T0LO_REG.
      T0LO           : aliased ESP32C3_SVD.UInt32;
      --  TIMG_T0HI_REG.
      T0HI           : aliased T0HI_Register;
      --  TIMG_T0UPDATE_REG.
      T0UPDATE       : aliased T0UPDATE_Register;
      --  TIMG_T0ALARMLO_REG.
      T0ALARMLO      : aliased ESP32C3_SVD.UInt32;
      --  TIMG_T0ALARMHI_REG.
      T0ALARMHI      : aliased T0ALARMHI_Register;
      --  TIMG_T0LOADLO_REG.
      T0LOADLO       : aliased ESP32C3_SVD.UInt32;
      --  TIMG_T0LOADHI_REG.
      T0LOADHI       : aliased T0LOADHI_Register;
      --  TIMG_T0LOAD_REG.
      T0LOAD         : aliased ESP32C3_SVD.UInt32;
      --  TIMG_WDTCONFIG0_REG.
      ...
      --  TIMG_WDTCONFIG5_REG.
      WDTCONFIG5     : aliased ESP32C3_SVD.UInt32;
      --  TIMG_WDTFEED_REG.
      WDTFEED        : aliased ESP32C3_SVD.UInt32;
