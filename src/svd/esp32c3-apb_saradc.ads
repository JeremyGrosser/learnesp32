...
package ESP32C3.APB_SARADC is
   ...
   subtype CTRL_SARADC_SAR_CLK_DIV_Field is HAL.Byte;
   ...
   subtype CTRL2_SARADC_MAX_MEAS_NUM_Field is HAL.Byte;
   ...
   subtype FSM_WAIT_SARADC_XPD_WAIT_Field is HAL.Byte;
   subtype FSM_WAIT_SARADC_RSTB_WAIT_Field is HAL.Byte;
   subtype FSM_WAIT_SARADC_STANDBY_WAIT_Field is HAL.Byte;
   ...
   subtype CLKM_CONF_CLKM_DIV_NUM_Field is HAL.Byte;
   ...
   subtype APB_TSENS_CTRL_TSENS_OUT_Field is HAL.Byte;
   subtype APB_TSENS_CTRL_TSENS_CLK_DIV_Field is HAL.Byte;
