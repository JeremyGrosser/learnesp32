...
package ESP32C3_SVD.XTS_AES is
   pragma Preelaborate;
   ...
   --  The memory that stores plaintext
   type PLAIN_MEM_Registers is array (0 .. 15) of ESP32C3_SVD.UInt8;
   ...
   subtype PHYSICAL_ADDRESS_PHYSICAL_ADDRESS_Field is ESP32C3_SVD.UInt30;
