...
package ESP32C3_SVD.UHCI is
   ...
   type INT_RAW_Register is record
      ...
      --  Read-only. This is the interrupt raw bit. Triggered when there are
      --  some errors in EOF in the
   ...
   subtype STATE0_RX_ERR_CAUSE_Field is ESP32C3_SVD.UInt3;
   subtype STATE0_DECODE_STATE_Field is ESP32C3_SVD.UInt3;
   ...
   subtype STATE1_ENCODE_STATE_Field is ESP32C3_SVD.UInt3;
   ...
   subtype HUNG_CONF_TXFIFO_TIMEOUT_Field is ESP32C3_SVD.UInt8;
   subtype HUNG_CONF_TXFIFO_TIMEOUT_SHIFT_Field is ESP32C3_SVD.UInt3;
   subtype HUNG_CONF_RXFIFO_TIMEOUT_Field is ESP32C3_SVD.UInt8;
   subtype HUNG_CONF_RXFIFO_TIMEOUT_SHIFT_Field is ESP32C3_SVD.UInt3;
   ...
   subtype ACK_NUM_ACK_NUM_Field is ESP32C3_SVD.UInt3;
   ...
   subtype QUICK_SENT_SINGLE_SEND_NUM_Field is ESP32C3_SVD.UInt3;
   subtype QUICK_SENT_ALWAYS_SEND_NUM_Field is ESP32C3_SVD.UInt3;
   ...
   subtype ESC_CONF0_SEPER_CHAR_Field is ESP32C3_SVD.UInt8;
   --  ESC_CONF0_SEPER_ESC_CHAR array element
   subtype ESC_CONF0_SEPER_ESC_CHAR_Element is ESP32C3_SVD.UInt8;
   ...
   subtype ESC_CONF1_ESC_SEQ0_Field is ESP32C3_SVD.UInt8;
   --  ESC_CONF1_ESC_SEQ0_CHAR array element
   subtype ESC_CONF1_ESC_SEQ0_CHAR_Element is ESP32C3_SVD.UInt8;
   ...
   subtype ESC_CONF2_ESC_SEQ1_Field is ESP32C3_SVD.UInt8;
   --  ESC_CONF2_ESC_SEQ1_CHAR array element
   subtype ESC_CONF2_ESC_SEQ1_CHAR_Element is ESP32C3_SVD.UInt8;
   ...
   subtype ESC_CONF3_ESC_SEQ2_Field is ESP32C3_SVD.UInt8;
   --  ESC_CONF3_ESC_SEQ2_CHAR array element
   subtype ESC_CONF3_ESC_SEQ2_CHAR_Element is ESP32C3_SVD.UInt8;
   ...
   subtype PKT_THRES_PKT_THRS_Field is ESP32C3_SVD.UInt13;
   ...
   type UHCI_Peripheral is record
      ...
      --  a
      RX_HEAD      : aliased ESP32C3_SVD.UInt32;
      --  a
      QUICK_SENT   : aliased QUICK_SENT_Register;
      --  a
      REG_Q0_WORD0 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q0_WORD1 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q1_WORD0 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q1_WORD1 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q2_WORD0 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q2_WORD1 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q3_WORD0 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q3_WORD1 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q4_WORD0 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q4_WORD1 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q5_WORD0 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q5_WORD1 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q6_WORD0 : aliased ESP32C3_SVD.UInt32;
      --  a
      REG_Q6_WORD1 : aliased ESP32C3_SVD.UInt32;
      --  a
