...
package ESP32C3_SVD.SPI1 is
   ...
   subtype CMD_SPI1_MST_ST_Field is ESP32C3_SVD.UInt4;
   subtype CMD_MSPI_ST_Field is ESP32C3_SVD.UInt4;
   ...
   type CMD_Register is record
      ...
      --  unspecified
      Reserved_8_16 : ESP32C3_SVD.UInt9 := 16#0#;
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_12_12 : ESP32C3_SVD.Bit := 16#0#;
      ...
      --  unspecified
      Reserved_16_17 : ESP32C3_SVD.UInt2 := 16#0#;
   ...
   subtype CTRL1_CLK_MODE_Field is ESP32C3_SVD.UInt2;
   subtype CTRL1_CS_HOLD_DLY_RES_Field is ESP32C3_SVD.UInt10;
   ...
   subtype CLOCK_CLKCNT_L_Field is ESP32C3_SVD.UInt8;
   subtype CLOCK_CLKCNT_H_Field is ESP32C3_SVD.UInt8;
   subtype CLOCK_CLKCNT_N_Field is ESP32C3_SVD.UInt8;
   ...
   type CLOCK_Register is record
      ...
      --  unspecified
      Reserved_24_30 : ESP32C3_SVD.UInt7 := 16#0#;
      --  reserved
   ...
   type USER_Register is record
      --  unspecified
      Reserved_0_8      : ESP32C3_SVD.UInt9 := 16#0#;
      ...
      --  unspecified
      Reserved_16_23    : ESP32C3_SVD.UInt8 := 16#0#;
   ...
   subtype USER1_USR_DUMMY_CYCLELEN_Field is ESP32C3_SVD.UInt6;
   subtype USER1_USR_ADDR_BITLEN_Field is ESP32C3_SVD.UInt6;
   ...
   type USER1_Register is record
      ...
      --  unspecified
      Reserved_6_25      : ESP32C3_SVD.UInt20 := 16#0#;
   ...
   subtype USER2_USR_COMMAND_VALUE_Field is ESP32C3_SVD.UInt16;
   subtype USER2_USR_COMMAND_BITLEN_Field is ESP32C3_SVD.UInt4;
   ...
   type USER2_Register is record
      ...
      --  unspecified
      Reserved_16_27     : ESP32C3_SVD.UInt12 := 16#0#;
   ...
   subtype MOSI_DLEN_USR_MOSI_DBITLEN_Field is ESP32C3_SVD.UInt10;
   ...
   subtype MISO_DLEN_USR_MISO_DBITLEN_Field is ESP32C3_SVD.UInt10;
   ...
   subtype RD_STATUS_STATUS_Field is ESP32C3_SVD.UInt16;
   subtype RD_STATUS_WB_MODE_Field is ESP32C3_SVD.UInt8;
   ...
   type MISC_Register is record
      ...
      --  unspecified
      Reserved_2_8   : ESP32C3_SVD.UInt7 := 16#0#;
   ...
   type CACHE_FCTRL_Register is record
      ...
      --  0:disable.
      CACHE_USR_ADDR_4BYTE : Boolean := False;
      --  unspecified
   ...
   subtype FLASH_WAITI_CTRL_WAITI_CMD_Field is ESP32C3_SVD.UInt8;
   subtype FLASH_WAITI_CTRL_WAITI_DUMMY_CYCLELEN_Field is ESP32C3_SVD.UInt6;
   ...
   subtype FLASH_SUS_CTRL_PESR_END_MSK_Field is ESP32C3_SVD.UInt16;
   subtype FLASH_SUS_CTRL_SUS_TIMEOUT_CNT_Field is ESP32C3_SVD.UInt7;
   ...
   subtype FLASH_SUS_CMD_FLASH_PER_COMMAND_Field is ESP32C3_SVD.UInt8;
   subtype FLASH_SUS_CMD_FLASH_PES_COMMAND_Field is ESP32C3_SVD.UInt8;
   subtype FLASH_SUS_CMD_WAIT_PESR_COMMAND_Field is ESP32C3_SVD.UInt16;
   ...
   type SUS_STATUS_Register is record
      ...
      WAIT_PESR_CMD_2B  : Boolean := False;
      ...
      FLASH_PER_DLY_128 : Boolean := False;
      ...
      FLASH_PES_DLY_128 : Boolean := False;
      --  1: Enable SPI0 lock SPI0/1 arbiter option. 0: Disable it.
      SPI0_LOCK_EN      : Boolean := False;
      --  unspecified
   ...
   subtype TIMING_CALI_EXTRA_DUMMY_CYCLELEN_Field is ESP32C3_SVD.UInt3;
   ...
   type INT_RAW_Register is record
      --  Read-only. The raw bit for SPI_MEM_PER_END_INT interrupt. 1:
      --  Triggered when Auto Resume command (0x7A) is sent and flash is
      --  resumed. 0: Others.
      PER_END_INT_RAW    : Boolean;
      --  Read-only. The raw bit for SPI_MEM_PES_END_INT interrupt.1: Triggered
      --  when Auto Suspend command (0x75) is sent and flash is suspended. 0:
      --  Others.
      PES_END_INT_RAW    : Boolean;
      --  Read-only. The raw bit for SPI_MEM_WPE_END_INT interrupt. 1:
      --  Triggered when WRSR/PP/SE/BE/CE is sent and flash is already idle. 0:
      --  Others.
      WPE_END_INT_RAW    : Boolean;
      --  Read-only. The raw bit for SPI_MEM_SLV_ST_END_INT interrupt. 1:
      --  Triggered when spi1_slv_st is changed from non idle state to idle
      --  state. It means that SPI_CS raises high. 0: Others
      SLV_ST_END_INT_RAW : Boolean;
      --  Read-only. The raw bit for SPI_MEM_MST_ST_END_INT interrupt. 1:
      --  Triggered when spi1_mst_st is changed from non idle state to idle
      --  state. 0: Others.
      MST_ST_END_INT_RAW : Boolean;
      --  unspecified
   ...
   type SPI1_Peripheral is record
      ...
      ADDR             : aliased ESP32C3_SVD.UInt32;
      --  SPI1 control register.
      ...
      TX_CRC           : aliased ESP32C3_SVD.UInt32;
      --  SPI1 bit mode control register.
      CACHE_FCTRL      : aliased CACHE_FCTRL_Register;
      --  SPI1 memory data buffer0
      W0               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer1
      W1               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer2
      W2               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer3
      W3               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer4
      W4               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer5
      W5               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer6
      W6               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer7
      W7               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer8
      W8               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer9
      W9               : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer10
      W10              : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer11
      W11              : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer12
      W12              : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer13
      W13              : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer14
      W14              : aliased ESP32C3_SVD.UInt32;
      --  SPI1 memory data buffer15
      W15              : aliased ESP32C3_SVD.UInt32;
      --  SPI1 wait idle control register
