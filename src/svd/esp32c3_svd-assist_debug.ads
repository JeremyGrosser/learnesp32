...
package ESP32C3_SVD.ASSIST_DEBUG is
   pragma Preelaborate;
   ...
   type C0RE_0_MONTR_ENA_Register is record
   ...
   for C0RE_0_MONTR_ENA_Register use record
   ...
   type CORE_0_INTR_ENA_Register is record
      ...
      --  reg_core_0_iram0_exception_monitor_ena
      CORE_0_IRAM0_EXCEPTION_MONITOR_RLS : Boolean := False;
      --  reg_core_0_dram0_exception_monitor_ena
      CORE_0_DRAM0_EXCEPTION_MONITOR_RLS : Boolean := False;
      --  unspecified
      Reserved_12_31                     : ESP32C3_SVD.UInt20 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype LOG_SETTING_LOG_ENA_Field is ESP32C3_SVD.UInt3;
   subtype LOG_SETTING_LOG_MODE_Field is ESP32C3_SVD.UInt4;
   ...
   subtype LOG_DATA_MASK_LOG_DATA_SIZE_Field is ESP32C3_SVD.UInt16;
   ...
   subtype DATE_ASSIST_DEBUG_DATE_Field is ESP32C3_SVD.UInt28;
   ...
   type ASSIST_DEBUG_Peripheral is record
      --  ASSIST_DEBUG_C0RE_0_MONTR_ENA_REG
      C0RE_0_MONTR_ENA                       : aliased C0RE_0_MONTR_ENA_Register;
      --  ASSIST_DEBUG_CORE_0_INTR_RAW_REG
      ...
      CORE_0_AREA_DRAM0_0_MIN                : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_DRAM0_0_MAX_REG
      CORE_0_AREA_DRAM0_0_MAX                : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_DRAM0_1_MIN_REG
      CORE_0_AREA_DRAM0_1_MIN                : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_DRAM0_1_MAX_REG
      CORE_0_AREA_DRAM0_1_MAX                : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_PIF_0_MIN_REG
      CORE_0_AREA_PIF_0_MIN                  : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_PIF_0_MAX_REG
      CORE_0_AREA_PIF_0_MAX                  : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_PIF_1_MIN_REG
      CORE_0_AREA_PIF_1_MIN                  : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_PIF_1_MAX_REG
      CORE_0_AREA_PIF_1_MAX                  : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_PC_REG
      CORE_0_AREA_PC                         : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_AREA_SP_REG
      CORE_0_AREA_SP                         : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_SP_MIN_REG
      CORE_0_SP_MIN                          : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_SP_MAX_REG
      CORE_0_SP_MAX                          : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_SP_PC_REG
      CORE_0_SP_PC                           : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_RCD_EN_REG
      CORE_0_RCD_EN                          : aliased CORE_0_RCD_EN_Register;
      --  ASSIST_DEBUG_CORE_0_RCD_PDEBUGPC_REG
      CORE_0_RCD_PDEBUGPC                    : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_RCD_PDEBUGSP_REG
      CORE_0_RCD_PDEBUGSP                    : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_RCD_PDEBUGSP_REG
      ...
      --  ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_1_REG
      CORE_0_DRAM0_EXCEPTION_MONITOR_1       : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_0_DRAM0_EXCEPTION_MONITOR_1_REG
      ...
      CORE_0_DRAM0_EXCEPTION_MONITOR_3       : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_CORE_X_IRAM0_DRAM0_EXCEPTION_MONITOR_0_REG
      ...
      LOG_DATA_0                             : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_LOG_DATA_MASK_REG
      LOG_DATA_MASK                          : aliased LOG_DATA_MASK_Register;
      --  ASSIST_DEBUG_LOG_MIN_REG
      LOG_MIN                                : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_LOG_MAX_REG
      LOG_MAX                                : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_LOG_MEM_START_REG
      LOG_MEM_START                          : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_LOG_MEM_END_REG
      LOG_MEM_END                            : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_LOG_MEM_WRITING_ADDR_REG
      LOG_MEM_WRITING_ADDR                   : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_LOG_MEM_FULL_FLAG_REG
      LOG_MEM_FULL_FLAG                      : aliased LOG_MEM_FULL_FLAG_Register;
      --  ASSIST_DEBUG_C0RE_0_LASTPC_BEFORE_EXCEPTION
      C0RE_0_LASTPC_BEFORE_EXCEPTION         : aliased ESP32C3_SVD.UInt32;
      --  ASSIST_DEBUG_C0RE_0_DEBUG_MODE
   ...
   for ASSIST_DEBUG_Peripheral use record
      C0RE_0_MONTR_ENA                       at 16#0# range 0 .. 31;
