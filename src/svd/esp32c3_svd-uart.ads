...
package ESP32C3_SVD.UART is
   ...
   subtype FIFO_RXFIFO_RD_BYTE_Field is ESP32C3_SVD.UInt8;
   ...
   type INT_RAW_Register is record
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  receives more data than what rxfifo_full_thrhd specifies.
      RXFIFO_FULL_INT_RAW      : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when the amount
      --  of data in Tx-FIFO is less than what txfifo_empty_thrhd specifies .
      TXFIFO_EMPTY_INT_RAW     : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects a parity error in the data.
      PARITY_ERR_INT_RAW       : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects a data frame error .
      FRM_ERR_INT_RAW          : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  receives more data than the FIFO can store.
      RXFIFO_OVF_INT_RAW       : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects the edge change of DSRn signal.
      DSR_CHG_INT_RAW          : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects the edge change of CTSn signal.
      CTS_CHG_INT_RAW          : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects a 0 after the stop bit.
      BRK_DET_INT_RAW          : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  takes more time than rx_tout_thrhd to receive a byte.
      RXFIFO_TOUT_INT_RAW      : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  recevies Xon char when uart_sw_flow_con_en is set to 1.
      SW_XON_INT_RAW           : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  receives Xoff char when uart_sw_flow_con_en is set to 1.
      SW_XOFF_INT_RAW          : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects a glitch in the middle of a start bit.
      GLITCH_DET_INT_RAW       : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when
      --  transmitter completes sending NULL characters, after all data in
      --  Tx-FIFO are sent.
      TX_BRK_DONE_INT_RAW      : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when
      --  transmitter has kept the shortest duration after sending the last
      --  data.
      TX_BRK_IDLE_DONE_INT_RAW : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when
      --  transmitter has send out all data in FIFO.
      TX_DONE_INT_RAW          : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects a parity error from the echo of transmitter in rs485 mode.
      RS485_PARITY_ERR_INT_RAW : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects a data frame error from the echo of transmitter in rs485
      --  mode.
      RS485_FRM_ERR_INT_RAW    : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when detects a
      --  clash between transmitter and receiver in rs485 mode.
      RS485_CLASH_INT_RAW      : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when receiver
      --  detects the configured at_cmd char.
      AT_CMD_CHAR_DET_INT_RAW  : Boolean;
      --  Read-only. This interrupt raw bit turns to high level when input rxd
      --  edge changes more times than what reg_active_threshold specifies in
      --  light sleeping mode.
      WAKEUP_INT_RAW           : Boolean;
      --  unspecified
      Reserved_20_31           : ESP32C3_SVD.UInt12;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type INT_ENA_Register is record
      ...
      RS485_PARITY_ERR_INT_ENA : Boolean := False;
      --  This is the enable bit for rs485_parity_err_int_st register.
      RS485_FRM_ERR_INT_ENA    : Boolean := False;
      --  This is the enable bit for rs485_clash_int_st register.
      RS485_CLASH_INT_ENA      : Boolean := False;
   ...
   subtype CLKDIV_CLKDIV_Field is ESP32C3_SVD.UInt12;
   subtype CLKDIV_FRAG_Field is ESP32C3_SVD.UInt4;
   ...
   type CLKDIV_Register is record
      ...
      --  unspecified
      Reserved_12_19 : ESP32C3_SVD.UInt8 := 16#0#;
   ...
   subtype RX_FILT_GLITCH_FILT_Field is ESP32C3_SVD.UInt8;
   ...
   subtype STATUS_RXFIFO_CNT_Field is ESP32C3_SVD.UInt10;
   subtype STATUS_TXFIFO_CNT_Field is ESP32C3_SVD.UInt10;
   ...
   type STATUS_Register is record
      ...
      --  unspecified
      Reserved_10_12 : ESP32C3_SVD.UInt3;
      ...
      --  unspecified
      Reserved_26_28 : ESP32C3_SVD.UInt3;
   ...
   subtype CONF0_BIT_NUM_Field is ESP32C3_SVD.UInt2;
   subtype CONF0_STOP_BIT_NUM_Field is ESP32C3_SVD.UInt2;
   ...
   subtype CONF1_RXFIFO_FULL_THRHD_Field is ESP32C3_SVD.UInt9;
   subtype CONF1_TXFIFO_EMPTY_THRHD_Field is ESP32C3_SVD.UInt9;
   ...
   subtype LOWPULSE_MIN_CNT_Field is ESP32C3_SVD.UInt12;
   ...
   type LOWPULSE_Register is record
      ...
      --  unspecified
      Reserved_12_31 : ESP32C3_SVD.UInt20;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype HIGHPULSE_MIN_CNT_Field is ESP32C3_SVD.UInt12;
   ...
   subtype RXD_CNT_RXD_EDGE_CNT_Field is ESP32C3_SVD.UInt10;
   ...
   type RXD_CNT_Register is record
      ...
      --  unspecified
      Reserved_10_31 : ESP32C3_SVD.UInt22;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SLEEP_CONF_ACTIVE_THRESHOLD_Field is ESP32C3_SVD.UInt10;
   ...
   subtype SWFC_CONF0_XOFF_THRESHOLD_Field is ESP32C3_SVD.UInt9;
   subtype SWFC_CONF0_XOFF_CHAR_Field is ESP32C3_SVD.UInt8;
   ...
   subtype SWFC_CONF1_XON_THRESHOLD_Field is ESP32C3_SVD.UInt9;
   subtype SWFC_CONF1_XON_CHAR_Field is ESP32C3_SVD.UInt8;
   ...
   subtype TXBRK_CONF_TX_BRK_NUM_Field is ESP32C3_SVD.UInt8;
   ...
   subtype IDLE_CONF_RX_IDLE_THRHD_Field is ESP32C3_SVD.UInt10;
   subtype IDLE_CONF_TX_IDLE_NUM_Field is ESP32C3_SVD.UInt10;
   ...
   subtype RS485_CONF_RS485_TX_DLY_NUM_Field is ESP32C3_SVD.UInt4;

   --  RS485 mode configuration
   type RS485_CONF_Register is record
      --  Set this bit to choose the rs485 mode.
      RS485_EN         : Boolean := False;
   ...
   subtype AT_CMD_PRECNT_PRE_IDLE_NUM_Field is ESP32C3_SVD.UInt16;
   ...
   subtype AT_CMD_POSTCNT_POST_IDLE_NUM_Field is ESP32C3_SVD.UInt16;
   ...
   subtype AT_CMD_GAPTOUT_RX_GAP_TOUT_Field is ESP32C3_SVD.UInt16;
   ...
   subtype AT_CMD_CHAR_AT_CMD_CHAR_Field is ESP32C3_SVD.UInt8;
   subtype AT_CMD_CHAR_CHAR_NUM_Field is ESP32C3_SVD.UInt8;
   ...
   subtype MEM_CONF_RX_SIZE_Field is ESP32C3_SVD.UInt3;
   subtype MEM_CONF_TX_SIZE_Field is ESP32C3_SVD.UInt3;
   subtype MEM_CONF_RX_FLOW_THRHD_Field is ESP32C3_SVD.UInt9;
   subtype MEM_CONF_RX_TOUT_THRHD_Field is ESP32C3_SVD.UInt10;
   ...
   subtype MEM_TX_STATUS_APB_TX_WADDR_Field is ESP32C3_SVD.UInt10;
   subtype MEM_TX_STATUS_TX_RADDR_Field is ESP32C3_SVD.UInt10;
   ...
   type MEM_TX_STATUS_Register is record
      ...
      --  unspecified
      Reserved_10_10 : ESP32C3_SVD.Bit;
      --  Read-only. This register stores the offset address in Tx-FIFO when
   ...
   subtype MEM_RX_STATUS_APB_RX_RADDR_Field is ESP32C3_SVD.UInt10;
   subtype MEM_RX_STATUS_RX_WADDR_Field is ESP32C3_SVD.UInt10;
   ...
   subtype FSM_STATUS_ST_URX_OUT_Field is ESP32C3_SVD.UInt4;
   subtype FSM_STATUS_ST_UTX_OUT_Field is ESP32C3_SVD.UInt4;
   ...
   subtype POSPULSE_POSEDGE_MIN_CNT_Field is ESP32C3_SVD.UInt12;
   ...
   subtype NEGPULSE_NEGEDGE_MIN_CNT_Field is ESP32C3_SVD.UInt12;
   ...
   subtype CLK_CONF_SCLK_SEL_Field is ESP32C3_SVD.UInt2;
   ...
   subtype ID_ID_Field is ESP32C3_SVD.UInt30;
