...
package ESP32C3_SVD.DS is
   ...
   --  memory that stores Y
   type Y_MEM_Registers is array (0 .. 511) of ESP32C3_SVD.UInt8;

   --  memory that stores M

   --  memory that stores M
   type M_MEM_Registers is array (0 .. 511) of ESP32C3_SVD.UInt8;

   --  memory that stores Rb

   --  memory that stores Rb
   type RB_MEM_Registers is array (0 .. 511) of ESP32C3_SVD.UInt8;

   --  memory that stores BOX

   --  memory that stores BOX
   type BOX_MEM_Registers is array (0 .. 47) of ESP32C3_SVD.UInt8;

   --  memory that stores X

   --  memory that stores X
   type X_MEM_Registers is array (0 .. 511) of ESP32C3_SVD.UInt8;

   --  memory that stores Z

   --  memory that stores Z
   type Z_MEM_Registers is array (0 .. 511) of ESP32C3_SVD.UInt8;
   ...
   subtype QUERY_KEY_WRONG_QUERY_KEY_WRONG_Field is ESP32C3_SVD.UInt4;
