...
package ESP32C3.SPI1 is
   ...
   subtype CMD_SPI1_MST_ST_Field is HAL.UInt4;
   subtype CMD_MSPI_ST_Field is HAL.UInt4;
   ...
   subtype CTRL1_CLK_MODE_Field is HAL.UInt2;
   subtype CTRL1_CS_HOLD_DLY_RES_Field is HAL.UInt10;
   ...
   subtype CLOCK_CLKCNT_L_Field is HAL.Byte;
   subtype CLOCK_CLKCNT_H_Field is HAL.Byte;
   subtype CLOCK_CLKCNT_N_Field is HAL.Byte;
   ...
   subtype USER1_USR_DUMMY_CYCLELEN_Field is HAL.UInt6;
   subtype USER1_USR_ADDR_BITLEN_Field is HAL.UInt6;
   ...
   subtype MOSI_DLEN_USR_MOSI_DBITLEN_Field is HAL.UInt10;
   ...
   subtype MISO_DLEN_USR_MISO_DBITLEN_Field is HAL.UInt10;
   ...
   subtype RD_STATUS_STATUS_Field is HAL.UInt16;
   subtype RD_STATUS_WB_MODE_Field is HAL.Byte;
   ...
   subtype FLASH_WAITI_CTRL_WAITI_CMD_Field is HAL.Byte;
   subtype FLASH_WAITI_CTRL_WAITI_DUMMY_CYCLELEN_Field is HAL.UInt6;
   ...
   subtype FLASH_SUS_CTRL_PESR_END_MSK_Field is HAL.UInt16;
   subtype FLASH_SUS_CTRL_SUS_TIMEOUT_CNT_Field is HAL.UInt7;
   ...
   subtype FLASH_SUS_CMD_FLASH_PER_COMMAND_Field is HAL.Byte;
   subtype FLASH_SUS_CMD_FLASH_PES_COMMAND_Field is HAL.Byte;
   subtype FLASH_SUS_CMD_WAIT_PESR_COMMAND_Field is HAL.UInt16;
   ...
   subtype TIMING_CALI_EXTRA_DUMMY_CYCLELEN_Field is HAL.UInt3;
