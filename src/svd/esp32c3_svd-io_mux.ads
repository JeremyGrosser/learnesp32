...
package ESP32C3_SVD.IO_MUX is
   ...
   subtype PIN_CTRL_CLK_OUT_Element is ESP32C3_SVD.UInt4;
   ...
   subtype GPIO_FUN_DRV_Field is ESP32C3_SVD.UInt2;
   subtype GPIO_MCU_SEL_Field is ESP32C3_SVD.UInt3;
   ...
   subtype DATE_REG_DATE_Field is ESP32C3_SVD.UInt28;
