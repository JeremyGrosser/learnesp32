...
package ESP32C3.SHA is
   ...
   subtype T_LENGTH_T_LENGTH_Field is HAL.UInt6;
   ...
   subtype DMA_BLOCK_NUM_DMA_BLOCK_NUM_Field is HAL.UInt6;
   ...
   subtype START_START_Field is HAL.UInt31;
   ...
   subtype CONTINUE_CONTINUE_Field is HAL.UInt31;
   ...
   --  Sha H memory which contains intermediate hash or finial hash.
   type H_MEM_Registers is array (0 .. 63) of HAL.Byte;

   --  Sha M memory which contains message.

   --  Sha M memory which contains message.
   type M_MEM_Registers is array (0 .. 63) of HAL.Byte;
