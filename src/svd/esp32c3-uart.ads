...
package ESP32C3.UART is
   ...
   subtype FIFO_RXFIFO_RD_BYTE_Field is HAL.Byte;
   ...
   subtype RX_FILT_GLITCH_FILT_Field is HAL.Byte;
   ...
   subtype STATUS_RXFIFO_CNT_Field is HAL.UInt10;
   subtype STATUS_TXFIFO_CNT_Field is HAL.UInt10;
   ...
   subtype CONF1_RXFIFO_FULL_THRHD_Field is HAL.UInt9;
   subtype CONF1_TXFIFO_EMPTY_THRHD_Field is HAL.UInt9;
   ...
   subtype LOWPULSE_MIN_CNT_Field is HAL.UInt12;
   ...
   subtype HIGHPULSE_MIN_CNT_Field is HAL.UInt12;
   ...
   subtype RXD_CNT_RXD_EDGE_CNT_Field is HAL.UInt10;
   ...
   subtype SLEEP_CONF_ACTIVE_THRESHOLD_Field is HAL.UInt10;
   ...
   subtype SWFC_CONF0_XOFF_THRESHOLD_Field is HAL.UInt9;
   subtype SWFC_CONF0_XOFF_CHAR_Field is HAL.Byte;
   ...
   subtype SWFC_CONF1_XON_THRESHOLD_Field is HAL.UInt9;
   subtype SWFC_CONF1_XON_CHAR_Field is HAL.Byte;
   ...
   subtype TXBRK_CONF_TX_BRK_NUM_Field is HAL.Byte;
   ...
   subtype RS485_CONF_RS485_TX_DLY_NUM_Field is HAL.UInt4;
   ...
   subtype AT_CMD_CHAR_AT_CMD_CHAR_Field is HAL.Byte;
   subtype AT_CMD_CHAR_CHAR_NUM_Field is HAL.Byte;
   ...
   subtype MEM_CONF_RX_SIZE_Field is HAL.UInt3;
   subtype MEM_CONF_TX_SIZE_Field is HAL.UInt3;
   subtype MEM_CONF_RX_FLOW_THRHD_Field is HAL.UInt9;
   subtype MEM_CONF_RX_TOUT_THRHD_Field is HAL.UInt10;
   ...
   subtype MEM_TX_STATUS_APB_TX_WADDR_Field is HAL.UInt10;
   subtype MEM_TX_STATUS_TX_RADDR_Field is HAL.UInt10;
   ...
   subtype MEM_RX_STATUS_APB_RX_RADDR_Field is HAL.UInt10;
   subtype MEM_RX_STATUS_RX_WADDR_Field is HAL.UInt10;
   ...
   subtype POSPULSE_POSEDGE_MIN_CNT_Field is HAL.UInt12;
   ...
   subtype NEGPULSE_NEGEDGE_MIN_CNT_Field is HAL.UInt12;
   ...
   subtype ID_ID_Field is HAL.UInt30;
