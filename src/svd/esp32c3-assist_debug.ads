...
package ESP32C3.ASSIST_DEBUG is
   pragma Preelaborate;
   ...
   subtype LOG_DATA_MASK_LOG_DATA_SIZE_Field is HAL.UInt16;
   ...
   type ASSIST_DEBUG_Peripheral is record
      ...
      LOG_MEM_WRITING_ADDR                   : aliased HAL.UInt32;
      --  ASSIST_DEBUG_LOG_MEM_FULL_FLAG_REG
