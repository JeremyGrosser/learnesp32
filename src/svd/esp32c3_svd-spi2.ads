...
package ESP32C3_SVD.SPI2 is
   ...
   subtype CMD_CONF_BITLEN_Field is ESP32C3_SVD.UInt18;
   ...
   type CTRL_Register is record
      ...
      --  unspecified
      Reserved_10_13 : ESP32C3_SVD.UInt4 := 16#0#;
      ...
      WP_POL         : Boolean := True;
      --  unspecified
      Reserved_22_24 : ESP32C3_SVD.UInt3 := 16#0#;
   ...
   subtype CLOCK_CLKCNT_L_Field is ESP32C3_SVD.UInt6;
   subtype CLOCK_CLKCNT_H_Field is ESP32C3_SVD.UInt6;
   subtype CLOCK_CLKCNT_N_Field is ESP32C3_SVD.UInt6;
   subtype CLOCK_CLKDIV_PRE_Field is ESP32C3_SVD.UInt4;
   ...
   type CLOCK_Register is record
      ...
      --  unspecified
      Reserved_22_30 : ESP32C3_SVD.UInt9 := 16#0#;
   ...
   type USER_Register is record
      ...
      --  unspecified
      Reserved_1_2      : ESP32C3_SVD.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_16_16    : ESP32C3_SVD.Bit := 16#0#;
      ...
      SIO               : Boolean := False;
      --  unspecified
      Reserved_18_23    : ESP32C3_SVD.UInt6 := 16#0#;
   ...
   subtype USER1_USR_DUMMY_CYCLELEN_Field is ESP32C3_SVD.UInt8;
   subtype USER1_CS_SETUP_TIME_Field is ESP32C3_SVD.UInt5;
   subtype USER1_CS_HOLD_TIME_Field is ESP32C3_SVD.UInt5;
   subtype USER1_USR_ADDR_BITLEN_Field is ESP32C3_SVD.UInt5;
   ...
   type USER1_Register is record
      ...
      --  unspecified
      Reserved_8_15        : ESP32C3_SVD.UInt8 := 16#0#;
   ...
   type USER2_Register is record
      ...
      --  unspecified
      Reserved_16_26        : ESP32C3_SVD.UInt11 := 16#0#;
   ...
   subtype MS_DLEN_MS_DATA_BITLEN_Field is ESP32C3_SVD.UInt18;
   ...
   subtype MISC_MASTER_CS_POL_Field is ESP32C3_SVD.UInt6;
   ...
   subtype DIN_MODE_DIN0_MODE_Field is ESP32C3_SVD.UInt2;
   subtype DIN_MODE_DIN1_MODE_Field is ESP32C3_SVD.UInt2;
   subtype DIN_MODE_DIN2_MODE_Field is ESP32C3_SVD.UInt2;
   subtype DIN_MODE_DIN3_MODE_Field is ESP32C3_SVD.UInt2;
   ...
   subtype DIN_NUM_DIN0_NUM_Field is ESP32C3_SVD.UInt2;
   subtype DIN_NUM_DIN1_NUM_Field is ESP32C3_SVD.UInt2;
   subtype DIN_NUM_DIN2_NUM_Field is ESP32C3_SVD.UInt2;
   subtype DIN_NUM_DIN3_NUM_Field is ESP32C3_SVD.UInt2;
   ...
   type DMA_CONF_Register is record
      ...
      --  unspecified
      Reserved_22_26          : ESP32C3_SVD.UInt5 := 16#0#;
   ...
   subtype SLAVE_CLK_MODE_Field is ESP32C3_SVD.UInt2;
   subtype SLAVE_DMA_SEG_MAGIC_VALUE_Field is ESP32C3_SVD.UInt4;
   ...
   type SLAVE_Register is record
      ...
      --  unspecified
      Reserved_4_7        : ESP32C3_SVD.UInt4 := 16#0#;
      ...
      --  unspecified
      Reserved_12_21      : ESP32C3_SVD.UInt10 := 16#0#;
   ...
   subtype SLAVE1_SLV_DATA_BITLEN_Field is ESP32C3_SVD.UInt18;
   subtype SLAVE1_SLV_LAST_COMMAND_Field is ESP32C3_SVD.UInt8;
   subtype SLAVE1_SLV_LAST_ADDR_Field is ESP32C3_SVD.UInt6;
