...
package ESP32C3_SVD.AES is
   ...
   subtype MODE_MODE_Field is ESP32C3_SVD.UInt3;
   ...
   subtype ENDIAN_ENDIAN_Field is ESP32C3_SVD.UInt6;
   ...
   subtype STATE_STATE_Field is ESP32C3_SVD.UInt2;
   ...
   --  The memory that stores initialization vector
   type IV_MEM_Registers is array (0 .. 15) of ESP32C3_SVD.UInt8;

   --  The memory that stores GCM hash subkey

   --  The memory that stores GCM hash subkey
   type H_MEM_Registers is array (0 .. 15) of ESP32C3_SVD.UInt8;

   --  The memory that stores J0

   --  The memory that stores J0
   type J0_MEM_Registers is array (0 .. 15) of ESP32C3_SVD.UInt8;

   --  The memory that stores T0

   --  The memory that stores T0
   type T0_MEM_Registers is array (0 .. 15) of ESP32C3_SVD.UInt8;

   --  DMA-AES working mode register
   type DMA_ENABLE_Register is record
      --  1'b0: typical AES working mode, 1'b1: DMA-AES working mode.
      DMA_ENABLE    : Boolean := False;
      --  unspecified
      Reserved_1_31 : ESP32C3_SVD.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype BLOCK_MODE_BLOCK_MODE_Field is ESP32C3_SVD.UInt3;
   ...
   subtype REMAINDER_BIT_NUM_REMAINDER_BIT_NUM_Field is ESP32C3_SVD.UInt7;
