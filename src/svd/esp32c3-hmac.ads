...
package ESP32C3.HMAC is
   ...
   subtype SET_PARA_PURPOSE_PURPOSE_SET_Field is HAL.UInt4;
   ...
   subtype SET_PARA_KEY_KEY_SET_Field is HAL.UInt3;
   ...
   --  Message block memory.
   type WR_MESSAGE_MEM_Registers is array (0 .. 63) of HAL.Byte;

   --  Result from upstream.

   --  Result from upstream.
   type RD_RESULT_MEM_Registers is array (0 .. 31) of HAL.Byte;
