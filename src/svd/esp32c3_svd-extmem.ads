...
package ESP32C3_SVD.EXTMEM is
   ...
   type ICACHE_CTRL1_Register is record
      ...
      ICACHE_SHUT_IBUS : Boolean := True;
      --  The bit is used to disable core1 ibus, 0: enable, 1: disable
      ICACHE_SHUT_DBUS : Boolean := True;
      --  unspecified
   ...
   subtype ICACHE_LOCK_SIZE_ICACHE_LOCK_SIZE_Field is ESP32C3_SVD.UInt16;
   ...
   subtype ICACHE_SYNC_SIZE_ICACHE_SYNC_SIZE_Field is ESP32C3_SVD.UInt23;
   ...
   subtype ICACHE_PRELOAD_SIZE_ICACHE_PRELOAD_SIZE_Field is ESP32C3_SVD.UInt16;
   ...
   type ICACHE_AUTOLOAD_SCT0_SIZE_Register is record
      ...
      ICACHE_AUTOLOAD_SCT0_SIZE : ICACHE_AUTOLOAD_SCT0_SIZE_ICACHE_AUTOLOAD_SCT0_SIZE_Field :=
                                   16#0#;
      --  unspecified
      Reserved_27_31            : ESP32C3_SVD.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type CACHE_ACS_CNT_CLR_Register is record
      ...
      IBUS_ACS_CNT_CLR : Boolean := False;
      --  Write-only. The bit is used to clear dbus counter.
      DBUS_ACS_CNT_CLR : Boolean := False;
      --  unspecified
      Reserved_2_31    : ESP32C3_SVD.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type CACHE_ILG_INT_ENA_Register is record
      ...
      --  unspecified
      Reserved_2_4                    : ESP32C3_SVD.UInt3 := 16#0#;
   ...
   type CACHE_ILG_INT_ST_Register is record
      ...
      --  unspecified
      Reserved_11_31                 : ESP32C3_SVD.UInt21;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type CORE0_ACS_CACHE_INT_ST_Register is record
      ...
      --  speculative access.
      CORE0_DBUS_ACS_MSK_ICACHE_ST : Boolean;
      --  Read-only. The bit is used to indicate interrupt by authentication
      --  fail.
      CORE0_DBUS_REJECT_ST         : Boolean;
      --  Read-only. The bit is used to indicate interrupt by dbus trying to
      --  write icache
      CORE0_DBUS_WR_ICACHE_ST      : Boolean;
      --  unspecified
      Reserved_6_31                : ESP32C3_SVD.UInt26;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CORE0_DBUS_REJECT_ST_CORE0_DBUS_ATTR_Field is ESP32C3_SVD.UInt3;
   ...
   subtype CORE0_IBUS_REJECT_ST_CORE0_IBUS_ATTR_Field is ESP32C3_SVD.UInt3;
   ...
   subtype CACHE_STATE_ICACHE_STATE_Field is ESP32C3_SVD.UInt12;
   ...
   subtype CACHE_MMU_OWNER_CACHE_MMU_OWNER_Field is ESP32C3_SVD.UInt4;
   ...
   subtype IBUS_PMS_TBL_BOUNDARY0_IBUS_PMS_BOUNDARY0_Field is
     ESP32C3_SVD.UInt12;
   ...
   subtype IBUS_PMS_TBL_BOUNDARY1_IBUS_PMS_BOUNDARY1_Field is
     ESP32C3_SVD.UInt12;
   ...
   subtype IBUS_PMS_TBL_BOUNDARY2_IBUS_PMS_BOUNDARY2_Field is
     ESP32C3_SVD.UInt12;
   ...
   subtype IBUS_PMS_TBL_ATTR_IBUS_PMS_SCT1_ATTR_Field is ESP32C3_SVD.UInt4;
   subtype IBUS_PMS_TBL_ATTR_IBUS_PMS_SCT2_ATTR_Field is ESP32C3_SVD.UInt4;
   ...
   subtype DBUS_PMS_TBL_BOUNDARY0_DBUS_PMS_BOUNDARY0_Field is
     ESP32C3_SVD.UInt12;
   ...
   subtype DBUS_PMS_TBL_BOUNDARY1_DBUS_PMS_BOUNDARY1_Field is
     ESP32C3_SVD.UInt12;
   ...
   subtype DBUS_PMS_TBL_BOUNDARY2_DBUS_PMS_BOUNDARY2_Field is
     ESP32C3_SVD.UInt12;
   ...
   subtype DBUS_PMS_TBL_ATTR_DBUS_PMS_SCT1_ATTR_Field is ESP32C3_SVD.UInt2;
   subtype DBUS_PMS_TBL_ATTR_DBUS_PMS_SCT2_ATTR_Field is ESP32C3_SVD.UInt2;
   ...
   subtype REG_DATE_DATE_Field is ESP32C3_SVD.UInt28;
   ...
   type EXTMEM_Peripheral is record
      ...
      --  This description will be updated in the near future.
      ICACHE_PRELOCK_SCT0_ADDR             : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      ICACHE_PRELOCK_SCT1_ADDR             : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      ICACHE_PRELOCK_SCT_SIZE              : aliased ICACHE_PRELOCK_SCT_SIZE_Register;
      --  This description will be updated in the near future.
      ICACHE_LOCK_CTRL                     : aliased ICACHE_LOCK_CTRL_Register;
      --  This description will be updated in the near future.
      ICACHE_LOCK_ADDR                     : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      ICACHE_LOCK_SIZE                     : aliased ICACHE_LOCK_SIZE_Register;
      --  This description will be updated in the near future.
      ICACHE_SYNC_CTRL                     : aliased ICACHE_SYNC_CTRL_Register;
      --  This description will be updated in the near future.
      ICACHE_SYNC_ADDR                     : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      ICACHE_SYNC_SIZE                     : aliased ICACHE_SYNC_SIZE_Register;
      --  This description will be updated in the near future.
      ICACHE_PRELOAD_CTRL                  : aliased ICACHE_PRELOAD_CTRL_Register;
      --  This description will be updated in the near future.
      ICACHE_PRELOAD_ADDR                  : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      ICACHE_PRELOAD_SIZE                  : aliased ICACHE_PRELOAD_SIZE_Register;
      --  This description will be updated in the near future.
      ICACHE_AUTOLOAD_CTRL                 : aliased ICACHE_AUTOLOAD_CTRL_Register;
      --  This description will be updated in the near future.
      ICACHE_AUTOLOAD_SCT0_ADDR            : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      ICACHE_AUTOLOAD_SCT0_SIZE            : aliased ICACHE_AUTOLOAD_SCT0_SIZE_Register;
      --  This description will be updated in the near future.
      ICACHE_AUTOLOAD_SCT1_ADDR            : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      ICACHE_AUTOLOAD_SCT1_SIZE            : aliased ICACHE_AUTOLOAD_SCT1_SIZE_Register;
      --  This description will be updated in the near future.
      IBUS_TO_FLASH_START_VADDR            : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      IBUS_TO_FLASH_END_VADDR              : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      DBUS_TO_FLASH_START_VADDR            : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      DBUS_TO_FLASH_END_VADDR              : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      CACHE_ACS_CNT_CLR                    : aliased CACHE_ACS_CNT_CLR_Register;
      --  This description will be updated in the near future.
      IBUS_ACS_MISS_CNT                    : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      IBUS_ACS_CNT                         : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      DBUS_ACS_FLASH_MISS_CNT              : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      DBUS_ACS_CNT                         : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      ...
      --  This description will be updated in the near future.
      CORE0_DBUS_REJECT_VADDR              : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      CORE0_IBUS_REJECT_ST                 : aliased CORE0_IBUS_REJECT_ST_Register;
      --  This description will be updated in the near future.
      CORE0_IBUS_REJECT_VADDR              : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
      CACHE_MMU_FAULT_CONTENT              : aliased CACHE_MMU_FAULT_CONTENT_Register;
      --  This description will be updated in the near future.
      CACHE_MMU_FAULT_VADDR                : aliased ESP32C3_SVD.UInt32;
      --  This description will be updated in the near future.
