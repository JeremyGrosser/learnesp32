...
package ESP32C3_SVD.HMAC is
   ...
   subtype SET_PARA_PURPOSE_PURPOSE_SET_Field is ESP32C3_SVD.UInt4;
   ...
   subtype SET_PARA_KEY_KEY_SET_Field is ESP32C3_SVD.UInt3;
   ...
   type SET_INVALIDATE_JTAG_Register is record
      ...
      SET_INVALIDATE_JTAG : Boolean := False;
      --  unspecified
      Reserved_1_31       : ESP32C3_SVD.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type SET_INVALIDATE_DS_Register is record
      ...
      SET_INVALIDATE_DS : Boolean := False;
      --  unspecified
      Reserved_1_31     : ESP32C3_SVD.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   --  Message block memory.
   type WR_MESSAGE_MEM_Registers is array (0 .. 63) of ESP32C3_SVD.UInt8;

   --  Result from upstream.

   --  Result from upstream.
   type RD_RESULT_MEM_Registers is array (0 .. 31) of ESP32C3_SVD.UInt8;

   --  Process control register 5.
   type SET_MESSAGE_PAD_Register is record
      --  Write-only. Start software padding.
      SET_TEXT_PAD  : Boolean := False;
      --  unspecified
      Reserved_1_31 : ESP32C3_SVD.UInt31 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type HMAC_Peripheral is record
      ...
      --  Jtag register 1.
      WR_JTAG             : aliased ESP32C3_SVD.UInt32;
   end record
     with Volatile;
