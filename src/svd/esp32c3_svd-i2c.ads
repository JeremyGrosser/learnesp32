...
package ESP32C3_SVD.I2C is
   ...
   subtype SCL_LOW_PERIOD_SCL_LOW_PERIOD_Field is ESP32C3_SVD.UInt9;
   ...
   type SCL_LOW_PERIOD_Register is record
      ...
      --  unspecified
      Reserved_9_31  : ESP32C3_SVD.UInt23 := 16#0#;
   end record
   ...
   type CTR_Register is record
      --  reg_sda_force_out
      SDA_FORCE_OUT          : Boolean := True;
      --  reg_scl_force_out
      SCL_FORCE_OUT          : Boolean := True;
      --  reg_sample_scl_level
      SAMPLE_SCL_LEVEL       : Boolean := False;
      --  reg_rx_full_ack_level
      RX_FULL_ACK_LEVEL      : Boolean := True;
      --  reg_ms_mode
      MS_MODE                : Boolean := False;
      --  Write-only. reg_trans_start
      TRANS_START            : Boolean := False;
      --  reg_tx_lsb_first
      TX_LSB_FIRST           : Boolean := False;
      --  reg_rx_lsb_first
      RX_LSB_FIRST           : Boolean := False;
      --  reg_clk_en
      CLK_EN                 : Boolean := False;
      --  reg_arbitration_en
      ARBITRATION_EN         : Boolean := True;
      --  Write-only. reg_fsm_rst
      FSM_RST                : Boolean := False;
      --  Write-only. reg_conf_upgate
      CONF_UPGATE            : Boolean := False;
      --  reg_slv_tx_auto_start_en
      SLV_TX_AUTO_START_EN   : Boolean := False;
      --  reg_addr_10bit_rw_check_en
      ADDR_10BIT_RW_CHECK_EN : Boolean := False;
      --  reg_addr_broadcasting_en
      ADDR_BROADCASTING_EN   : Boolean := False;
      --  unspecified
      Reserved_15_31         : ESP32C3_SVD.UInt17 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SR_RXFIFO_CNT_Field is ESP32C3_SVD.UInt6;
   subtype SR_STRETCH_CAUSE_Field is ESP32C3_SVD.UInt2;
   subtype SR_TXFIFO_CNT_Field is ESP32C3_SVD.UInt6;
   subtype SR_SCL_MAIN_STATE_LAST_Field is ESP32C3_SVD.UInt3;
   subtype SR_SCL_STATE_LAST_Field is ESP32C3_SVD.UInt3;
   ...
   subtype TO_TIME_OUT_VALUE_Field is ESP32C3_SVD.UInt5;
   ...
   subtype SLAVE_ADDR_SLAVE_ADDR_Field is ESP32C3_SVD.UInt15;
   ...
   type SLAVE_ADDR_Register is record
      ...
      --  unspecified
      Reserved_15_30 : ESP32C3_SVD.UInt16 := 16#0#;
      --  reg_addr_10bit_en
      ADDR_10BIT_EN  : Boolean := False;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype FIFO_ST_RXFIFO_RADDR_Field is ESP32C3_SVD.UInt5;
   subtype FIFO_ST_RXFIFO_WADDR_Field is ESP32C3_SVD.UInt5;
   subtype FIFO_ST_TXFIFO_RADDR_Field is ESP32C3_SVD.UInt5;
   subtype FIFO_ST_TXFIFO_WADDR_Field is ESP32C3_SVD.UInt5;
   subtype FIFO_ST_SLAVE_RW_POINT_Field is ESP32C3_SVD.UInt8;
   ...
   subtype FIFO_CONF_RXFIFO_WM_THRHD_Field is ESP32C3_SVD.UInt5;
   subtype FIFO_CONF_TXFIFO_WM_THRHD_Field is ESP32C3_SVD.UInt5;
   ...
   type FIFO_CONF_Register is record
      ...
      FIFO_ADDR_CFG_EN : Boolean := False;
      --  reg_rx_fifo_rst
   ...
   subtype DATA_FIFO_RDATA_Field is ESP32C3_SVD.UInt8;
   ...
   type INT_ENA_Register is record
      ...
      RXFIFO_WM_INT_ENA        : Boolean := False;
      --  reg_txfifo_wm_int_ena
      TXFIFO_WM_INT_ENA        : Boolean := False;
      --  reg_rxfifo_ovf_int_ena
      RXFIFO_OVF_INT_ENA       : Boolean := False;
      --  reg_end_detect_int_ena
      END_DETECT_INT_ENA       : Boolean := False;
      --  reg_byte_trans_done_int_ena
      BYTE_TRANS_DONE_INT_ENA  : Boolean := False;
      --  reg_arbitration_lost_int_ena
      ARBITRATION_LOST_INT_ENA : Boolean := False;
      --  reg_mst_txfifo_udf_int_ena
      MST_TXFIFO_UDF_INT_ENA   : Boolean := False;
      --  reg_trans_complete_int_ena
      TRANS_COMPLETE_INT_ENA   : Boolean := False;
      --  reg_time_out_int_ena
      TIME_OUT_INT_ENA         : Boolean := False;
      --  reg_trans_start_int_ena
      TRANS_START_INT_ENA      : Boolean := False;
      --  reg_nack_int_ena
      NACK_INT_ENA             : Boolean := False;
      --  reg_txfifo_ovf_int_ena
      TXFIFO_OVF_INT_ENA       : Boolean := False;
      --  reg_rxfifo_udf_int_ena
      RXFIFO_UDF_INT_ENA       : Boolean := False;
      --  reg_scl_st_to_int_ena
      SCL_ST_TO_INT_ENA        : Boolean := False;
      --  reg_scl_main_st_to_int_ena
      SCL_MAIN_ST_TO_INT_ENA   : Boolean := False;
      --  reg_det_start_int_ena
      DET_START_INT_ENA        : Boolean := False;
      --  reg_slave_stretch_int_ena
      SLAVE_STRETCH_INT_ENA    : Boolean := False;
      --  reg_general_call_int_ena
      GENERAL_CALL_INT_ENA     : Boolean := False;
      --  unspecified
      Reserved_18_31           : ESP32C3_SVD.UInt14 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype SDA_HOLD_TIME_Field is ESP32C3_SVD.UInt9;
   ...
   subtype SDA_SAMPLE_TIME_Field is ESP32C3_SVD.UInt9;
   ...
   subtype SCL_HIGH_PERIOD_SCL_HIGH_PERIOD_Field is ESP32C3_SVD.UInt9;
   subtype SCL_HIGH_PERIOD_SCL_WAIT_HIGH_PERIOD_Field is ESP32C3_SVD.UInt7;
   ...
   subtype SCL_START_HOLD_TIME_Field is ESP32C3_SVD.UInt9;
   ...
   subtype SCL_RSTART_SETUP_TIME_Field is ESP32C3_SVD.UInt9;
   ...
   subtype SCL_STOP_HOLD_TIME_Field is ESP32C3_SVD.UInt9;
   ...
   subtype SCL_STOP_SETUP_TIME_Field is ESP32C3_SVD.UInt9;
   ...
   subtype FILTER_CFG_SCL_FILTER_THRES_Field is ESP32C3_SVD.UInt4;
   subtype FILTER_CFG_SDA_FILTER_THRES_Field is ESP32C3_SVD.UInt4;
   ...
   type FILTER_CFG_Register is record
      ...
      --  reg_scl_filter_en
      SCL_FILTER_EN    : Boolean := True;
      --  reg_sda_filter_en
      SDA_FILTER_EN    : Boolean := True;
      --  unspecified
      Reserved_10_31   : ESP32C3_SVD.UInt22 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype CLK_CONF_SCLK_DIV_NUM_Field is ESP32C3_SVD.UInt8;
   subtype CLK_CONF_SCLK_DIV_A_Field is ESP32C3_SVD.UInt6;
   subtype CLK_CONF_SCLK_DIV_B_Field is ESP32C3_SVD.UInt6;
   ...
   subtype COMD_COMMAND_Field is ESP32C3_SVD.UInt14;
   ...
   type COMD_Register is record
      ...
      --  unspecified
      Reserved_14_30 : ESP32C3_SVD.UInt17 := 16#0#;
      --  reg_command_done
   ...
   subtype SCL_ST_TIME_OUT_SCL_ST_TO_I2C_Field is ESP32C3_SVD.UInt5;
   ...
   type SCL_ST_TIME_OUT_Register is record
      ...
      --  unspecified
      Reserved_5_31 : ESP32C3_SVD.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype SCL_MAIN_ST_TIME_OUT_SCL_MAIN_ST_TO_I2C_Field is ESP32C3_SVD.UInt5;
   ...
   subtype SCL_SP_CONF_SCL_RST_SLV_NUM_Field is ESP32C3_SVD.UInt5;

   --  I2C_SCL_SP_CONF_REG
   type SCL_SP_CONF_Register is record
      --  reg_scl_rst_slv_en
      SCL_RST_SLV_EN  : Boolean := False;
      --  reg_scl_rst_slv_num
      SCL_RST_SLV_NUM : SCL_SP_CONF_SCL_RST_SLV_NUM_Field := 16#0#;
      --  reg_scl_pd_en
      SCL_PD_EN       : Boolean := False;
      --  reg_sda_pd_en
      SDA_PD_EN       : Boolean := False;
      --  unspecified
      Reserved_8_31   : ESP32C3_SVD.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype SCL_STRETCH_CONF_STRETCH_PROTECT_NUM_Field is ESP32C3_SVD.UInt10;
   ...
   type SCL_STRETCH_CONF_Register is record
      ...
      SLAVE_SCL_STRETCH_EN  : Boolean := False;
      --  Write-only. reg_slave_scl_stretch_clr
      SLAVE_SCL_STRETCH_CLR : Boolean := False;
      --  reg_slave_byte_ack_ctl_en
      SLAVE_BYTE_ACK_CTL_EN : Boolean := False;
      --  reg_slave_byte_ack_lvl
      SLAVE_BYTE_ACK_LVL    : Boolean := False;
      --  unspecified
      Reserved_14_31        : ESP32C3_SVD.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type I2C0_Peripheral is record
      ...
      --  I2C_DATE_REG
      DATE                 : aliased ESP32C3_SVD.UInt32;
      --  I2C_TXFIFO_START_ADDR_REG
      TXFIFO_START_ADDR    : aliased ESP32C3_SVD.UInt32;
      --  I2C_RXFIFO_START_ADDR_REG
      RXFIFO_START_ADDR    : aliased ESP32C3_SVD.UInt32;
   end record
     with Volatile;
