...
package ESP32C3.SYSTEM is
   ...
   subtype CPU_PER_CONF_CPUPERIOD_SEL_Field is HAL.UInt2;
   subtype CPU_PER_CONF_CPU_WAITI_DELAY_NUM_Field is HAL.UInt4;
   ...
   subtype BT_LPCK_DIV_INT_BT_LPCK_DIV_NUM_Field is HAL.UInt12;
   ...
   subtype BT_LPCK_DIV_FRAC_BT_LPCK_DIV_B_Field is HAL.UInt12;
   subtype BT_LPCK_DIV_FRAC_BT_LPCK_DIV_A_Field is HAL.UInt12;
   ...
   subtype RTC_FASTMEM_CONFIG_RTC_MEM_CRC_ADDR_Field is HAL.UInt11;
   subtype RTC_FASTMEM_CONFIG_RTC_MEM_CRC_LEN_Field is HAL.UInt11;
   ...
   subtype MEM_PVT_MEM_PATH_LEN_Field is HAL.UInt4;
   subtype MEM_PVT_MEM_TIMING_ERR_CNT_Field is HAL.UInt16;
   subtype MEM_PVT_MEM_VT_SEL_Field is HAL.UInt2;
   ...
   subtype COMB_PVT_LVT_CONF_COMB_PATH_LEN_LVT_Field is HAL.UInt5;
   ...
   subtype COMB_PVT_NVT_CONF_COMB_PATH_LEN_NVT_Field is HAL.UInt5;
   ...
   subtype COMB_PVT_HVT_CONF_COMB_PATH_LEN_HVT_Field is HAL.UInt5;
   ...
   subtype SYSTEM_REG_DATE_SYSTEM_REG_DATE_Field is HAL.UInt28;
   ...
   type SYSTEM_Peripheral is record
      ...
      --  reserved
      RTC_FASTMEM_CRC                         : aliased HAL.UInt32;
      --  eco register
