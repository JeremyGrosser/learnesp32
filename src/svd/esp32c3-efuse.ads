...
package ESP32C3.EFUSE is
   ...
   subtype RD_REPEAT_DATA0_BTLC_GPIO_ENABLE_Field is HAL.UInt2;
   subtype RD_REPEAT_DATA0_POWER_GLITCH_DSENSE_Field is HAL.UInt2;
   ...
   subtype RD_REPEAT_DATA1_RPT4_RESERVED2_Field is HAL.UInt16;
   ...
   subtype RD_REPEAT_DATA2_RPT4_RESERVED3_Field is HAL.UInt4;
   subtype RD_REPEAT_DATA2_RPT4_RESERVED0_Field is HAL.UInt6;
   ...
   subtype RD_REPEAT_DATA3_FLASH_PAGE_SIZE_Field is HAL.UInt2;
   subtype RD_REPEAT_DATA3_SECURE_VERSION_Field is HAL.UInt16;
   subtype RD_REPEAT_DATA3_RPT4_RESERVED1_Field is HAL.UInt2;
   ...
   subtype RD_REPEAT_DATA4_RPT4_RESERVED4_Field is HAL.UInt24;
   ...
   subtype RD_MAC_SPI_SYS_1_SPI_PAD_CONF_0_Field is HAL.UInt16;
   ...
   subtype RD_REPEAT_ERR0_BTLC_GPIO_ENABLE_ERR_Field is HAL.UInt2;
   subtype RD_REPEAT_ERR0_POWER_GLITCH_DSENSE_ERR_Field is HAL.UInt2;
   ...
   subtype RD_REPEAT_ERR1_RPT4_RESERVED2_ERR_Field is HAL.UInt16;
   ...
   subtype RD_REPEAT_ERR2_RPT4_RESERVED3_ERR_Field is HAL.UInt4;
   subtype RD_REPEAT_ERR2_RPT4_RESERVED0_ERR_Field is HAL.UInt6;
   ...
   subtype RD_REPEAT_ERR3_FLASH_PAGE_SIZE_ERR_Field is HAL.UInt2;
   subtype RD_REPEAT_ERR3_SECURE_VERSION_ERR_Field is HAL.UInt16;
   subtype RD_REPEAT_ERR3_RPT4_RESERVED1_ERR_Field is HAL.UInt2;
   ...
   subtype RD_REPEAT_ERR4_RPT4_RESERVED4_ERR_Field is HAL.UInt24;
   ...
   subtype STATUS_REPEAT_ERR_CNT_Field is HAL.Byte;
   ...
   subtype DAC_CONF_DAC_CLK_DIV_Field is HAL.Byte;
   subtype DAC_CONF_DAC_NUM_Field is HAL.Byte;
   ...
   subtype RD_TIM_CONF_READ_INIT_NUM_Field is HAL.Byte;
   ...
   type EFUSE_Peripheral is record
      ...
      RD_MAC_SPI_SYS_2   : aliased HAL.UInt32;
      --  BLOCK1 data register 3.
