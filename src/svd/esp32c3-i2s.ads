...
package ESP32C3.I2S is
   ...
   subtype RX_CONF_RX_PCM_CONF_Field is HAL.UInt2;
   subtype RX_CONF_RX_STOP_MODE_Field is HAL.UInt2;
   ...
   subtype TX_CONF_TX_PCM_CONF_Field is HAL.UInt2;
   subtype TX_CONF_TX_CHAN_MOD_Field is HAL.UInt3;
   ...
   subtype RX_CONF1_RX_TDM_WS_WIDTH_Field is HAL.UInt7;
   subtype RX_CONF1_RX_BCK_DIV_NUM_Field is HAL.UInt6;
   subtype RX_CONF1_RX_BITS_MOD_Field is HAL.UInt5;
   subtype RX_CONF1_RX_HALF_SAMPLE_BITS_Field is HAL.UInt6;
   subtype RX_CONF1_RX_TDM_CHAN_BITS_Field is HAL.UInt5;
   ...
   subtype TX_CONF1_TX_TDM_WS_WIDTH_Field is HAL.UInt7;
   subtype TX_CONF1_TX_BCK_DIV_NUM_Field is HAL.UInt6;
   subtype TX_CONF1_TX_BITS_MOD_Field is HAL.UInt5;
   subtype TX_CONF1_TX_HALF_SAMPLE_BITS_Field is HAL.UInt6;
   subtype TX_CONF1_TX_TDM_CHAN_BITS_Field is HAL.UInt5;
   ...
   subtype RX_CLKM_CONF_RX_CLKM_DIV_NUM_Field is HAL.Byte;
   subtype RX_CLKM_CONF_RX_CLK_SEL_Field is HAL.UInt2;
   ...
   subtype TX_CLKM_CONF_TX_CLKM_DIV_NUM_Field is HAL.Byte;
   subtype TX_CLKM_CONF_TX_CLK_SEL_Field is HAL.UInt2;
   ...
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_Z_Field is HAL.UInt9;
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_Y_Field is HAL.UInt9;
   subtype RX_CLKM_DIV_CONF_RX_CLKM_DIV_X_Field is HAL.UInt9;
   ...
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_Z_Field is HAL.UInt9;
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_Y_Field is HAL.UInt9;
   subtype TX_CLKM_DIV_CONF_TX_CLKM_DIV_X_Field is HAL.UInt9;
   ...
   subtype TX_PCM2PDM_CONF_TX_PDM_SINC_OSR2_Field is HAL.UInt4;
   subtype TX_PCM2PDM_CONF_TX_PDM_PRESCALE_Field is HAL.Byte;
   subtype TX_PCM2PDM_CONF_TX_PDM_HP_IN_SHIFT_Field is HAL.UInt2;
   subtype TX_PCM2PDM_CONF_TX_PDM_LP_IN_SHIFT_Field is HAL.UInt2;
   subtype TX_PCM2PDM_CONF_TX_PDM_SINC_IN_SHIFT_Field is HAL.UInt2;
   subtype TX_PCM2PDM_CONF_TX_PDM_SIGMADELTA_IN_SHIFT_Field is HAL.UInt2;
   ...
   subtype TX_PCM2PDM_CONF1_TX_PDM_FP_Field is HAL.UInt10;
   subtype TX_PCM2PDM_CONF1_TX_PDM_FS_Field is HAL.UInt10;
   subtype TX_PCM2PDM_CONF1_TX_IIR_HP_MULT12_5_Field is HAL.UInt3;
   subtype TX_PCM2PDM_CONF1_TX_IIR_HP_MULT12_0_Field is HAL.UInt3;
   ...
   subtype RX_TDM_CTRL_RX_TDM_TOT_CHAN_NUM_Field is HAL.UInt4;
   ...
   subtype TX_TDM_CTRL_TX_TDM_TOT_CHAN_NUM_Field is HAL.UInt4;
   ...
   subtype RX_TIMING_RX_SD_IN_DM_Field is HAL.UInt2;
   subtype RX_TIMING_RX_WS_OUT_DM_Field is HAL.UInt2;
   subtype RX_TIMING_RX_BCK_OUT_DM_Field is HAL.UInt2;
   subtype RX_TIMING_RX_WS_IN_DM_Field is HAL.UInt2;
   subtype RX_TIMING_RX_BCK_IN_DM_Field is HAL.UInt2;
   ...
   subtype TX_TIMING_TX_SD_OUT_DM_Field is HAL.UInt2;
   subtype TX_TIMING_TX_SD1_OUT_DM_Field is HAL.UInt2;
   subtype TX_TIMING_TX_WS_OUT_DM_Field is HAL.UInt2;
   subtype TX_TIMING_TX_BCK_OUT_DM_Field is HAL.UInt2;
   subtype TX_TIMING_TX_WS_IN_DM_Field is HAL.UInt2;
   subtype TX_TIMING_TX_BCK_IN_DM_Field is HAL.UInt2;
   ...
   subtype LC_HUNG_CONF_LC_FIFO_TIMEOUT_Field is HAL.Byte;
   subtype LC_HUNG_CONF_LC_FIFO_TIMEOUT_SHIFT_Field is HAL.UInt3;
   ...
   subtype RXEOF_NUM_RX_EOF_NUM_Field is HAL.UInt12;
   ...
   type I2S_Peripheral is record
      ...
      CONF_SIGLE_DATA  : aliased HAL.UInt32;
      --  I2S TX status register
