...
package ESP32C3_SVD.RMT is
   ...
   subtype CH_TX_CONF0_DIV_CNT_Field is ESP32C3_SVD.UInt8;
   subtype CH_TX_CONF0_MEM_SIZE_Field is ESP32C3_SVD.UInt3;
   ...
   type CH_TX_CONF0_Register is record
      ...
      --  unspecified
      Reserved_19_19 : ESP32C3_SVD.Bit := 16#0#;
   ...
   subtype CH_RX_CONF_DIV_CNT_Field is ESP32C3_SVD.UInt8;
   subtype CH_RX_CONF_IDLE_THRES_Field is ESP32C3_SVD.UInt15;
   subtype CH_RX_CONF_MEM_SIZE_Field is ESP32C3_SVD.UInt3;
   ...
   subtype CH2CONF1_RX_FILTER_THRES_Field is ESP32C3_SVD.UInt8;
   ...
   subtype CH3CONF1_RX_FILTER_THRES_Field is ESP32C3_SVD.UInt8;
   ...
   subtype CH0STATUS_MEM_RADDR_EX_Field is ESP32C3_SVD.UInt9;
   subtype CH0STATUS_STATE_Field is ESP32C3_SVD.UInt3;
   subtype CH0STATUS_APB_MEM_WADDR_Field is ESP32C3_SVD.UInt9;
   subtype CH0STATUS_APB_MEM_RADDR_Field is ESP32C3_SVD.UInt8;
   ...
   subtype CH1STATUS_MEM_RADDR_EX_Field is ESP32C3_SVD.UInt9;
   subtype CH1STATUS_STATE_Field is ESP32C3_SVD.UInt3;
   subtype CH1STATUS_APB_MEM_WADDR_Field is ESP32C3_SVD.UInt9;
   subtype CH1STATUS_APB_MEM_RADDR_Field is ESP32C3_SVD.UInt8;
   ...
   subtype CH2STATUS_MEM_WADDR_EX_Field is ESP32C3_SVD.UInt9;
   subtype CH2STATUS_APB_MEM_RADDR_Field is ESP32C3_SVD.UInt9;
   subtype CH2STATUS_STATE_Field is ESP32C3_SVD.UInt3;
   ...
   subtype CH3STATUS_MEM_WADDR_EX_Field is ESP32C3_SVD.UInt9;
   subtype CH3STATUS_APB_MEM_RADDR_Field is ESP32C3_SVD.UInt9;
   subtype CH3STATUS_STATE_Field is ESP32C3_SVD.UInt3;
   ...
   type INT_ENA_Register is record
      ...
      --  unspecified
      Reserved_5_5              : ESP32C3_SVD.Bit := 16#0#;
      --  reg_ch2_err_int_ena.
      CH%s_RX_ERR_INT_ENA       : Boolean := False;
      --  unspecified
      Reserved_7_7              : ESP32C3_SVD.Bit := 16#0#;
   ...
   subtype CH0CARRIER_DUTY_CARRIER_LOW_Field is ESP32C3_SVD.UInt16;
   subtype CH0CARRIER_DUTY_CARRIER_HIGH_Field is ESP32C3_SVD.UInt16;
   ...
   subtype CH1CARRIER_DUTY_CARRIER_LOW_Field is ESP32C3_SVD.UInt16;
   subtype CH1CARRIER_DUTY_CARRIER_HIGH_Field is ESP32C3_SVD.UInt16;
   ...
   subtype CH2_RX_CARRIER_RM_CARRIER_LOW_THRES_Field is ESP32C3_SVD.UInt16;
   subtype CH2_RX_CARRIER_RM_CARRIER_HIGH_THRES_Field is ESP32C3_SVD.UInt16;
   ...
   subtype CH3_RX_CARRIER_RM_CARRIER_LOW_THRES_Field is ESP32C3_SVD.UInt16;
   subtype CH3_RX_CARRIER_RM_CARRIER_HIGH_THRES_Field is ESP32C3_SVD.UInt16;
   ...
   subtype CH_TX_LIM_TX_LIM_Field is ESP32C3_SVD.UInt9;
   subtype CH_TX_LIM_TX_LOOP_NUM_Field is ESP32C3_SVD.UInt10;
   ...
   subtype CH_RX_LIM_RX_LIM_Field is ESP32C3_SVD.UInt9;
   ...
   subtype SYS_CONF_SCLK_DIV_NUM_Field is ESP32C3_SVD.UInt8;
   subtype SYS_CONF_SCLK_DIV_A_Field is ESP32C3_SVD.UInt6;
   subtype SYS_CONF_SCLK_DIV_B_Field is ESP32C3_SVD.UInt6;
   subtype SYS_CONF_SCLK_SEL_Field is ESP32C3_SVD.UInt2;
   ...
   type SYS_CONF_Register is record
      ...
      --  unspecified
      Reserved_27_30   : ESP32C3_SVD.UInt4 := 16#0#;
      --  reg_clk_en.
   ...
   type RMT_Peripheral is record
      --  RMT_CH0DATA_REG.
      CH0DATA           : aliased ESP32C3_SVD.UInt32;
      --  RMT_CH1DATA_REG.
      CH1DATA           : aliased ESP32C3_SVD.UInt32;
      --  RMT_CH2DATA_REG.
      CH2DATA           : aliased ESP32C3_SVD.UInt32;
      --  RMT_CH3DATA_REG.
      CH3DATA           : aliased ESP32C3_SVD.UInt32;
      --  RMT_CH%sCONF%s_REG.
