...
package ESP32C3.SPI0 is
   ...
   subtype CTRL2_CS_SETUP_TIME_Field is HAL.UInt5;
   subtype CTRL2_CS_HOLD_TIME_Field is HAL.UInt5;
   subtype CTRL2_CS_HOLD_DELAY_Field is HAL.UInt6;
   ...
   subtype FSM_CSPI_ST_Field is HAL.UInt4;
   subtype FSM_EM_ST_Field is HAL.UInt3;
   subtype FSM_CSPI_LOCK_DELAY_TIME_Field is HAL.UInt5;
   ...
   subtype CORE_CLK_SEL_SPI01_CLK_SEL_Field is HAL.UInt2;
